 ...
 *
 * 202 entradas: 58 de 1º, 48 de 2º, 40 de 3º, 30 de 4º, 26 de 5º.
 *
 * Texto, aprimoramentos e campos de bloco importados do Grimório T20
 * (https://eduardomarques.pythonanywhere.com/) em 26/08/2026:
 * filtro "Edição Jogo do Ano" (197 magias) mais
 * 5 de suplemento já presentes no catálogo
 * (Ameaças de Arton, Dragão Brasil). Convenções locais: Resistência vazia em vez de
 * "nenhuma"; Truque como último parágrafo da descrição; "Lendas e Histórias" (site usa &);
 * "Gêiser Cáustico" (site grafa sem acento); campos do bloco sem ponto final; alcance de
 * Área Escorregadia e Explosão Caleidoscópica corrigido para "curto" (erro de digitação no site).
 *
...
Truque: o alimento é purificado (não causa nenhum efeito nocivo se estava estragado ou envenenado), mas não fornece bônus ao ser consumido.`,
  ...
  },
  {
    ...
    castingTime: 'padrão',
    range: 'pessoal',
    area: 'açoite de chamas criado em sua mão (veja texto)',
    duration: 'sustentada',
    resistance: 'Reflexos reduz parcial',
    ...
    enhancements: [
      { mpCost: 2, description: `muda a execução para movimento.` },
      { mpCost: 2, description: `muda o dano para 4d6. Requer 2° círculo.` },
      { mpCost: 5, description: `muda o dano para 6d6. Requer 3° círculo.` },
    ],
  },
  {
    id: 'adaga-mental',
...
Área Escorregadia pode tornar um item escorregadio. Uma criatura segurando um objeto afetado deve passar na resistência para não deixar o item cair cada vez que usá-lo.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, a arma o protege. Você recebe +1 na Defesa.` },
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      { mpCost: 2, description: `muda a duração para sustentada. Além do normal, uma vez por rodada, você pode gastar uma ação livre para fazer a arma acertar automaticamente um alvo adjacente. Se a arma atacar, não poderá contra-atacar até seu próximo turno. Requer 2º círculo.` },
      { mpCost: 2, description: `muda o tipo do dano para essência. Requer 2º círculo.` },
      { mpCost: 2, description: `aumenta o dano causado pela arma em +1d6 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a execução para reação. Em vez do normal, quando sofre um ataque, você cria um escudo mágico que fornece +5 na Defesa contra esse ataque (cumulativo com o bônus do efeito básico desta magia e de armaduras).` },
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      { mpCost: 2, description: `muda a duração para um dia.` },
    ],
  },
  {
  ...
  },
  {
    ...
    duration: 'instantânea',
    resistance: '',
    description: `Envia um aviso telepático para uma criatura, mesmo que não possa vê-la nem tenha linha de efeito. Escolha um: Alerta: o alvo recebe +5 em seu próximo teste de Iniciativa e de Percepção dentro da cena.
...
Localização: o alvo sabe onde você está naquele momento. Se você mudar de posição, ele não saberá.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alvo para 1 cadáver e a duração para 1 semana. O cadáver não se decompõe nem pode ser transformado em morto-vivo.` },
      { mpCost: 2, description: `aumenta os bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).` },
      { mpCost: 1, description: `também deixa o alvo abençoado. (DB #219)` },
    ],
  },
  {
...
Venha: o alvo gasta seu turno se aproximando de você (usando todas as suas ações).`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda a execução para padrão e a duração para cena. Requer 2º círculo.` },
      { mpCost: 5, description: `além do normal, ao atacar você, um inimigo deve rolar dois dados e usar o pior resultado. Requer 3º círculo.` },
      { mpCost: 9, description: `muda a execução para padrão, o alcance para curto, o alvo para criaturas escolhidas e a duração para cena. Requer 4º círculo.` },
      { mpCost: 14, description: `muda a execução para padrão e a duração para um dia. Além do normal, você recebe um sexto sentido que o avisa de qualquer perigo ou ameaça. Você fica imune às condições surpreendido e desprevenido e recebe +10 na Defesa e Reflexos. Requer 5º círculo.` },
    ],
  },
  {
    id: 'conjurar-monstro',
...
Outros usos criativos para monstros conjurados ficam a critério do mestre. O monstro não age sem receber uma ordem. Para efeitos de jogo, o monstro conjurado tem For 2, Des 3 e todos os outros atributos nulos. Ele tem Defesa igual a sua, 20 pontos de vida e usa o seu valor para teste de Reflexos. Ele é imune a efeitos que pedem um teste de Fortitude ou Vontade.`,
    enhancements: [
      ...
      { mpCost: 2, description: `aumenta o tamanho do monstro para Médio. Ele tem For 4, Des 3, 45 PV, deslocamento 12m e seu ataque causa 2d6+6 pontos de dano.` },
      { mpCost: 2, description: `o monstro ganha resistência 5 contra dois tipos de dano (por exemplo, corte e frio).` },
      { mpCost: 4, description: `o monstro ganha uma nova ordem: Arma de Sopro. Para dar essa ordem você gasta 1 PM, e faz o monstro causar o dobro de seu dano de ataque em um cone de 6m a partir de si (Reflexos reduz à metade).` },
      { mpCost: 5, description: `aumenta o tamanho do monstro para Grande. Ele tem For 7, Des 2, 75 PV, deslocamento 12m e seu ataque causa 4d6+10 pontos de dano com 3m de alcance. Requer 2º círculo.` },
      ...
      { mpCost: 9, description: `aumenta o tamanho do monstro para Enorme. Ele tem For 11, Des 1, 110 PV, deslocamento 15m e seu ataque causa 4d8+15 pontos de dano com 4,5m de alcance. Requer 4º círculo.` },
      { mpCost: 14, description: `aumenta o tamanho do monstro para Colossal. Ele tem For 15, Des 0, 180 PV, deslocamento 15m e seu ataque causa 4d12+20 pontos de dano com 9m de alcance. Requer 5º círculo.` },
      { mpCost: 1, description: `[Ameaças de Arton] em vez de um monstro, você invoca 4 kobolds Pequenos, que têm For 1, Des 1, Def 12, 1 PV cada e causam, cada um, 1d6-1 pontos de dano com uma ordem atacar. Você pode comandar todos os kobolds com a mesma ação padrão, mas eles devem receber o mesmo tipo de ordem e não podem seguir a ordem lançar magia. Você pode usar este aprimoramento mais vezes para aumentar o número de kobolds em +1, mas não pode usá-lo em conjunto com outros aprimoramentos.` },
      { mpCost: 3, description: `[Ameaças de Arton] como acima, mas cada kobold tem For 4, Des 1, Def 19, 15 PV e causa 2d6+1 pontos de dano de corte com uma ordem atacar. Requer 2º círculo.` },
    ],
  },
  {
    id: 'consagrar',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `aumenta as penalidades para mortos-vivos em –1. (penalidade máxima limitada pelo círculo máximo de magia que você pode lançar)` },
...
Truque: muda a área para alvo de 1 planta e a resistência para nenhuma. Em vez do normal, você pode fazer a planta se mover como se fosse animada. Ela não pode causar dano ou atrapalhar a concentração de um conjurador.`,
    enhancements: [
      { mpCost: 1, description: `muda a duração para instantânea. Em vez do normal, as plantas na área diminuem, como se tivessem sido podadas. Terreno difícil muda para terreno normal e não fornece camuflagem. Esse efeito dissipa o uso normal de Controlar Plantas.` },
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 1, description: `se escolheu fogo, aumenta o dano inicial de cada chama em +1d6.` },
    ],
  },
  {
    id: 'criar-ilusao',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `também criar sensações táteis, como texturas criaturas que não saibam que é uma ilusão não conseguem atravessá-la sem passar em um teste de Vontade (objetos ainda a atravessam). A ilusão ainda é incapaz de causar ou sofrer dano. Requer 2º círculo.` },
...
Truque: muda o alvo para 1 morto-vivo. Em vez do normal, causa 1d8 pontos de dano de luz (Vontade reduz à metade).`,
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 5, description: `muda o alcance para pessoal e a área para esfera com 6m de raio. Todas as criaturas e objetos mundanos na área são afetados.` },
    ],
  },
  {
    id: 'detectar-ameacas',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `além do normal, você não fica surpreendido contra perigos detectados com sucesso e recebe +5 em testes de resistência contra armadilhas. Requer 2º círculo.` },
    ],
  },
  {
    id: 'detonacao-congelante',
...
Truque: muda o alcance para toque, o alvo para 1 criatura e a duração para 1 semana. Em vez do normal, você faz uma pequena alteração na aparência do alvo, como deixar o nariz vermelho ou fazer brotar um gerânio no alto da cabeça. A mudança é inofensiva, mas persistente — se a flor for arrancada, por exemplo, outra nascerá no local.`,
    enhancements: [
      ...
      { mpCost: 2, description: `muda o alcance para curto e o alvo para 1 criatura. Uma criatura involuntária pode anular o efeito com um teste de Vontade.` },
      { mpCost: 2, description: `a ilusão inclui odores e sensações. Isso muda o bônus em testes de Enganação para disfarce para +20.` },
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
    id: 'enfeiticar',
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 1, description: `também fornece ao alvo camuflagem leve contra ataques à distância.` },
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      ...
      { mpCost: 3, description: `muda a duração para um dia. Requer 2º círculo.` },
    ],
  },
  {
    id: 'escuridao',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `muda o efeito para fornecer camuflagem total por escuridão total. As sombras bloqueiam a visão na área e através dela.` },
      { mpCost: 2, description: `muda o alvo para 1 criatura e a resistência para Fortitude parcial. Você lança a magia nos olhos do alvo, que fica cego pela cena. Se passar na resistência, fica cego por 1 rodada. Requer 2º círculo.` },
      { mpCost: 3, description: `muda a duração para um dia.` },
      { mpCost: 5, description: `muda o alcance para pessoal e o alvo para você. Em vez do normal, você é coberto por sombras, recebendo +10 em testes de Furtividade e camuflagem leve. Requer 2º círculo.` },
    ],
  },
  {
...
Truque: muda o alcance para curto, a área para alvo de 1 objeto e a resistência para Reflexos anula. Você gera uma pequena explosão que não causa dano mas pode acender uma vela, tocha ou fogueira. Também pode fazer um objeto inflamável com RD 0 (como uma corda ou pergaminho) ficar em chamas. Uma criatura em posse de um objeto pode evitar esse efeito se passar no teste de resistência.`,
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +1d6.` },
      { mpCost: 1, description: `muda a resistência para Reflexos parcial. Se passar, a criatura reduz o dano à metade se falhar, fica em chamas (veja Condições, na página 394).` },
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
    ...
    range: 'médio',
    area: 'cilindro com 3m de diâmetro e 3m de altura',
    duration: 'instantânea',
    resistance: 'Reflexos reduz à metade',
...
Truque: muda a duração para 1 rodada. Em vez de fascinado, o alvo fica pasmo (apenas uma vez por cena).`,
    enhancements: [
      { mpCost: 1, description: `como o normal, mas alvos que passem na resistência não sabem que foram vítimas de uma magia.` },
      { mpCost: 2, description: `muda o alvo para animais ou humanoides escolhidos.` },
      { mpCost: 2, description: `muda a duração para sustentada.` },
      { mpCost: 2, description: `também afeta espíritos e monstros na área. Requer 2º círculo.` },
      { mpCost: 5, description: `também afeta construtos, espíritos, monstros e mortos-vivos na área. Requer 3º círculo.` },
    ],
  },
  {
    id: 'imagem-espelhada',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `além do normal, toda vez que uma cópia é destruída, emite um clarão de luz. A criatura que destruiu a cópia fica ofuscada por uma rodada. Requer 2º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, se falhar na resistência, o alvo fica fraco pela cena.` },
      { mpCost: 2, description: `aumenta o dano em 1d8+1.` },
      { mpCost: 2, description: `muda a resistência para nenhum. Como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e o efeito da magia.` },
      { mpCost: 5, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `além do normal, as criaturas afetadas ficam vulneráveis pela cena.` },
      { mpCost: 2, description: `também afeta espíritos e monstros na área. Requer 2º círculo.` },
      { mpCost: 5, description: `também afeta construtos, espíritos, monstros e mortos-vivos na área. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `muda a duração para um dia.` },
      { mpCost: 2, description: `muda a duração para permanente e adiciona componente material (pó de rubi no valor de T$ 50). Não pode ser usado em conjunto com outros aprimoramentos. Requer 2º círculo.` },
      ...
      { mpCost: 5, description: `(Apenas Divinos) muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo é envolto por um halo de luz, recebendo +10 em testes de Diplomacia e redução de trevas 10. Requer 2º círculo.` },
    ],
  },
  {
    id: 'nevoa',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `a nuvem tem um cheiro horrível. No início de seus turnos, qualquer criatura dentro dela, ou qualquer criatura com faro em alcance curto da nuvem, deve fazer um teste de Fortitude. Se falhar, fica enjoada por uma rodada.` },
      { mpCost: 2, description: `a nuvem tem um tom esverdeado e se torna cáustica. No início de seus turnos, criaturas dentro dela sofrem 2d4 pontos de dano de ácido.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta as penalidades em –1 (penalidade máxima limitada pelo círculo máximo de magia que você pode lançar).` },
    ],
  },
  {
    id: 'primor-atletico',
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `aumenta os bônus para mortos-vivos em +1. (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).` },
      { mpCost: 9, description: `muda a execução para 1 hora, a duração para permanente e adiciona componente material (incenso e óleos no valor de T$ 1.000). Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `muda a execução para reação, o alcance para curto e a duração para 1 rodada. Em vez do normal, o alvo recebe +5 no próximo teste de resistência que fizer (cumulativo com o efeito básico desta magia).` },
      { mpCost: 2, description: `muda o alvo para área de esfera com 3m de raio. Todos os aliados dentro do círculo recebem o bônus da. Requer 2º círculo.` },
      { mpCost: 5, description: `torna o alvo imune a efeitos mentais e de medo. Requer 3º círculo.` },
    ],
  },
  {
    id: 'queda-suave',
    ...
    castingTime: 'reação',
    range: 'curto',
    area: '1 criatura ou objeto Grande ou menor',
...
Truque: muda o alvo para objeto Minúsculo. Em vez do normal, você pode gastar uma ação de movimento para levitar o alvo até 4,5m em qualquer direção.`,
    enhancements: [
      { mpCost: 2, description: `muda o alvo para até 10 criaturas ou objetos adequados.` },
      { mpCost: 2, description: `aumenta a categoria de tamanho do alvo em uma.` },
      { mpCost: 1, description: `também deixa o alvo leve. (DB #219)` },
    ],
  },
  {
    ...
    duration: 'cena',
    resistance: 'Fortitude parcial',
    description: `Você dispara um raio púrpura que drena as forças do alvo. Se falhar na resistência, o alvo fica fatigado. Se passar, fica vulnerável. Note que, como efeitos de magia não acumulam, lançar esta duas vezes contra o mesmo alvo não irá deixá-lo exausto.
...
Truque: muda o alcance para toque e a resistência para Fortitude anula. Em vez do normal, sua mão emana um brilho púrpura e, ao tocar o alvo, ele fica fatigado.`,
    enhancements: [
      ...
      { mpCost: 5, description: `como acima, mas muda o alvo para criaturas escolhidas. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta a redução de dano em +5.` },
      { mpCost: 2, description: `muda a duração para um dia. Requer 2º círculo.` },
      { mpCost: 5, description: `muda o alcance para curto e o alvo para criaturas escolhidas. Requer 3º círculo.` },
      { mpCost: 5, description: `muda o efeito para redução de dano contra todos os tipos listados na. Requer 3º círculo.` },
      { mpCost: 9, description: `muda o efeito para imunidade a um tipo listado na magia. Requer 4º círculo.` },
    ],
  },
  {
    id: 'santuario',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, escolha um tipo de criatura entre animal, construto ou morto-vivo. Você não pode ser percebido por criaturas não inteligentes (Int –4 ou menor) do tipo escolhido.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `alvos que falhem na resistência ficam exaustos por 1d4+1 rodadas, em vez de apenas 1.` },
      { mpCost: 2, description: `muda o alvo para criatura.` },
      { mpCost: 5, description: `afeta todos os alvos válidos a sua escolha dentro do alcance.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +1d8+1.` },
      { mpCost: 2, description: `muda a resistências para nenhum. Como parte da execução da magia, você faz um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia.` },
      { mpCost: 2, description: `muda o alcance para pessoal e o alvo para Área: esfera com 6m de raio. Você dispara raios pelas pontas dos dedos que afetam todas as criaturas na área.` },
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
...
Truque: muda o alcance para curto. Em vez do normal, pode abrir ou fechar um objeto de tamanho Grande ou menor, como uma porta ou baú. Não afeta objetos trancados.`,
    enhancements: [
      { mpCost: 1, description: `muda o alcance para curto e a duração para instantânea. Em vez do normal, a magia abre portas, baús e janelas trancadas, presas, barradas ou protegidas por Tranca Arcana (o efeito é dissipado) a sua escolha. Ela também afrouxa grilhões e solta correntes.` },
...
Truque: muda o alvo para 1 objeto mundano Mínusculo (ou material em quantidade equivalente) e a duração para instantânea. Em vez do normal, você pode alterar as propriedades físicas do alvo, como colorir, limpar ou sujar itens pequenos (incluindo peças de roupa), aquecer, esfriar e/ou temperar (mas não produzir) ou curar 1 PV do objeto, consertando pequenas falhas como colar um frasco de cerâmica quebrado, unir os elos de uma corrente ou costurar uma roupa rasgada. Um objeto só pode ser afetado por este truque uma vez por dia.`,
    enhancements: [
      ...
      { mpCost: 3, description: `aumenta o preço máximo do objeto criado em um fator de x10 (+3 PM por T$ 250 de preço, +6 PM por T$ 2.500 de preço e assim por diante).` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta os PV temporários recebidos em +1d10. Caso a magia cause dano, em vez disso aumenta o dano causado em +1d10.` },
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 7, description: `muda o parceiro para mestre. Requer 3º círculo.` },
      { mpCost: 12, description: `muda o alvo para 2 animais prestativos. Cada animal funciona como um parceiro de um tipo diferente, e você pode receber a ajuda de ambos (mas ainda precisa seguir o limite de parceiros de acordo com o seu nível de personagem). Requer 4º círculo.` },
    ],
  },
  {
    id: 'alterar-tamanho',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo aumenta uma categoria de tamanho (seu equipamento se ajusta ao novo tamanho). O alvo também recebe Força +2. Um alvo involuntário pode fazer um teste de Fortitude para negar o efeito.` },
      { mpCost: 3, description: `muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo diminui uma categoria de tamanho (seu equipamento se ajusta ao novo tamanho). O alvo também recebe Destreza +2. Um alvo involuntário pode fazer um teste de Fortitude para negar o efeito. Requer 3º círculo.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `aumenta o número de laços em um alvo a sua escolha em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).` },
      { mpCost: 3, description: `em vez do normal, cada laço é destruído automaticamente com um único ataque bem-sucedido porém, cada laço destruído libera um choque de energia que causa 1d8+1 pontos de dano de essência na criatura amarrada. Requer 3º círculo.` },
    ],
  },
  {
...
Por exemplo, se o grupo está prestes a entrar em uma câmara, o augúrio dirá “felicidade” se a câmara contém um tesouro desprotegido, “miséria” se contém um monstro, “felicidade e miséria” se houver um tesouro e um monstro ou “nada” se a câmara estiver vazia.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a execução para reação e a duração para instantânea. Em vez do normal, você recebe RD 30 contra o próximo dano que sofrer.` },
      { mpCost: 3, description: `muda os PV temporários ou a RD para 50. Requer 3º círculo.` },
      { mpCost: 7, description: `muda os PV temporários ou a RD para 70. Requer 4º círculo.` },
      ...
      { mpCost: 9, description: `como o aprimoramento acima, mas tudo dentro da esfera fica praticamente sem peso. Uma vez por rodada, você pode gastar uma ação livre para flutuar a esfera e seu conteúdo 9m em uma direção. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `muda a duração para sustentada. A imagem do alvo fica mais distorcida, aumentando a chance de falha da camuflagem leve para 50%.` },
  ...
  },
  {
    ...
    duration: 'cena',
    resistance: '',
    description: `Pela duração da magia, você sabe a posição e status (PV atuais, se estão com uma condição ou sob efeito de magia...) dos alvos. Depois de lançada, a distância dos alvos não importa — a só deixa de detectar um alvo se ele morrer ou for para outro plano.`,
    enhancements: [
      { mpCost: 1, description: `aumenta o número de alvos em +1.` },
      { mpCost: 1, description: `muda a duração para um dia.` },
    ],
  },
  {
...
Sombra: como esqueletos, mas têm Des 4, Defesa 35, são incorpóreas e causam 2d10 pontos de dano de trevas. Além disso, criaturas vivas atingidas por uma sombra devem passar num teste de Fortitude ou perdem 1d4 PM. Sombras perdem a habilidade incorpóreo quando expostas à luz do sol.`,
    enhancements: [
      ...
      { mpCost: 3, description: `em vez de esqueletos, conjura carniçais. Requer 3º círculo.` },
      { mpCost: 7, description: `em vez de esqueletos, conjura sombras. Requer 4º círculo.` },
      { mpCost: 2, description: `[Ameaças de Arton] (Apenas Arcanos) em vez de esqueletos, conjura soterrados. Requer 3° círculo. Soterrado: como esqueletos, mas causam dano de frio. Além disso, criaturas atingidas por um soterrado devem passar num teste de Fortitude ou ficam enredadas por 1 rodada.` },
      { mpCost: 3, description: `[Ameaças de Arton] em vez de esqueletos, conjura fúrias de Tauron. Requer 3º círculo. Fúria de Tauron: como esqueletos, mas têm tamanho Pequeno, deslocamento de voo 12m, a habilidade incorpóreo, Des 5, Defesa 18 e causam 1d6 pontos de dano de trevas mais 1d6 pontos de dano de fogo. Além disso, criaturas vivas atingidas ficam desprevenidas por 1 rodada e em chamas (Fort CD igual à da magia evita).` },
      { mpCost: 3, description: `[Ameaças de Arton] (Apenas Devotos de Arsenal): em vez de esqueletos, conjura guerreiros perpétuos. Requer 3º círculo. Guerreiro Perpétuo: como esqueletos, mas têm For 5, Des 4, Defesa 33, a habilidade incorpóreo e causam 3d6 pontos de dano de impacto duas vezes por ação.` },
      { mpCost: 3, description: `[Ameaças de Arton] (Apenas Devotos de Sszzaas): em vez de esqueletos, conjura zumbis peçonha. Requer 3º círculo. Zumbi Peçonha: como esqueletos, mas têm For 3, Des 1, Defesa 25 e causam 1d8+1 pontos de dano de trevas mais perda de 2d6 PV por veneno. Além disso, criaturas atingidas por um zumbi peçonha ficam atordoadas por 1 rodada (apenas uma vez por cena) e depois fracas (Fort reduz para fracas por 1 rodada).` },
    ],
  },
  {
    id: 'controlar-fogo',
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `aumenta o dano em +1d6 (exceto do efeito chamejar).` },
...
Retorcer: estraga o alvo. Uma porta retorcida emperra (exigindo um teste de Força contra CD 25 para ser aberta). Armas e itens retorcidos impõem –5 em testes de perícia. Escudos retorcidos deixam de oferecer bônus (mas ainda impõem penalidades). Um barco retorcido começa a afundar e naufraga ao final da cena. Os efeitos de regras em outros objetos de madeira ficam a cargo do mestre.`,
    enhancements: [
      ...
      { mpCost: 7, description: `muda o tamanho do alvo para Enorme ou menor. Requer 3º círculo.` },
      { mpCost: 12, description: `muda o tamanho do alvo para Colossal ou menor. Requer 4º círculo.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 3, description: `além do normal, criaturas que falhem na resistência ficam aos prantos (pasmos) por 1 rodada (apenas uma vez por cena). Requer 3º círculo.` },
    ],
  },
  {
    id: 'dissipar-magia',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1. Todas as criaturas e objetos devem ser afetadas da mesma forma.` },
    ],
  },
  {
    id: 'fisico-divino',
    ...
    enhancements: [
      { mpCost: 3, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
      { mpCost: 3, description: `em vez do normal, o alvo recebe +2 nos três atributos físicos. Requer 3º círculo.` },
      { mpCost: 7, description: `em vez do normal, o alvo recebe +4 no atributo escolhido. Requer 4º círculo.` },
      { mpCost: 12, description: `em vez do normal, o alvo recebe +4 nos três atributos físicos. Requer 5º círculo.` },
    ],
  },
  {
    id: 'flecha-acida',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, se o alvo coberto pelo muco ácido estiver usando armadura ou escudo, o item é corroído. Isso reduz o bônus na Defesa do item em 1 ponto permanentemente. O item pode ser consertado, restaurando seu bônus (veja Ofício, na página 121).` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a execução para ação padrão, o alcance para toque e o alvo para 1 criatura ou 1 objeto Grande ou menor.` },
      ...
      { mpCost: 7, description: `muda a execução para ação padrão, o alcance para toque e o alvo para 1 criatura. A magia não é dissipada caso o alvo faça uma ação hostil. Requer 4º círculo.` },
    ],
  },
  {
    ...
    duration: '1 dia',
    resistance: '',
    description: `Você cria um elo mental entre duas criaturas com Inteligência -4 ou maior (você pode ser uma delas). As criaturas podem se comunicar independente de idioma ou distância, mas não em mundos diferentes.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 3, description: `muda o alvo para 1 criatura. Em vez do normal, você cria um elo mental que permite que você veja e ouça pelos sentidos da criatura, se gastar uma ação de movimento. Uma criatura involuntária pode fazer um teste de Vontade para suprimir a magia por uma hora. Requer 3º círculo.` },
    ],
  },
  {
    id: 'localizacao',
...
Truque: muda a área para alvo você. Em vez do normal, você sabe onde fica o norte e recebe +5 em testes de Sobrevivência para se orientar.`,
  ...
  },
  {
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: 'superfície ou objeto plano, como uma mesa ou papel',
    duration: 'cena',
    resistance: '',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `muda a duração para um dia. Se não estiver em combate, a criatura só pode fazer o teste de Vontade a cada hora. Requer 3º círculo.` },
      { mpCost: 3, description: `sempre que o alvo fizer o teste de Vontade e falhar, a marca causa 3d6 pontos de dano psíquico. Requer 3º círculo.` },
    ],
  },
  {
    id: 'mente-divina',
    ...
    enhancements: [
      { mpCost: 3, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
      { mpCost: 3, description: `em vez do normal, o alvo recebe +2 nos três atributos mentais. Requer 3º círculo.` },
      { mpCost: 7, description: `em vez do normal, o alvo recebe +4 no atributo escolhido. Requer 4º círculo.` },
      { mpCost: 12, description: `em vez do normal, o alvo recebe +4 nos três atributos mentais. Requer 5º círculo.` },
    ],
  },
  {
    id: 'metamorfose',
...
Truque: muda o alcance para toque, a área para alvo (1 criatura com 0 PV ou menos), a duração para instantânea, a resistência para Fortitude anula e adiciona componente material (pó de ônix no valor de T$ 10). Em vez do normal, você canaliza o Miasma contra uma vítima. Se falhar na resistência, ela morre e você recebe +2 na CD de suas magias por um dia. Se passar, fica imune a este truque por um dia.`,
  ...
  },
  {
    ...
    duration: '1 dia',
    resistance: '',
    description: `Montaria Arcana pode atravessar terreno difícil sem redução em seu deslocamento. Você pode usar Misticismo no lugar de Cavalgar para efeitos desta montaria (incluindo ser considerado treinado).`,
    enhancements: [
      { mpCost: 1, description: `além do normal, criaturas do tipo animal em alcance curto da montaria devem fazer um teste de Vontade. Se passarem, ficam abaladas pela cenase falharem, ficam apavoradas por 1d4 rodadas, depois abaladas pela cena.` },
      { mpCost: 3, description: `muda a duração para permanente e adiciona penalidade de –3 PM.` },
      ...
      { mpCost: 3, description: `muda o nível do parceiro para mestre. Requer 3º círculo.` },
    ],
  },
  {
    id: 'oracao',
  ...
  },
  {
    ...
    duration: 'instantânea',
    resistance: '',
    description: `Você purifica a criatura tocada, removendo uma condição dela entre abalado, apavorado, alquebrado, atordoado, cego, confuso, debilitado, enjoado, envenenado, esmorecido, exausto, fascinado, fatigado, fraco, frustrado, lento, ofuscado, paralisado, pasmo ou surdo. [decaído ou fedido (DB #219)]`,
    enhancements: [
      { mpCost: 2, description: `também recupera todos os PV perdidos por veneno.` },
  ...
  },
  {
    ...
    duration: 'instantânea',
    resistance: 'Reflexos (veja texto)',
    description: `Você canaliza uma poderosa rajada de energia positiva que ilumina o campo de batalha. Criaturas na área sofrem 4d8 pontos de dano de luz (ou 4d12, se forem mortos-vivos) e ficam ofuscadas por uma rodada. Se passarem na resistência, sofrem metade do dano e não ficam ofuscadas.
...
Isolamento: o alvo perde o uso de um de seus cinco sentidos a sua escolha. Se perder a visão, fica cego. Se perder a audição, fica surdo. Se perder o olfato ou paladar, não pode usar a habilidade faro. Se perder o tato, fica caído e não pode se levantar. Você também pode inventar sua própria maldição, usando esses exemplos como sugestões, mas o mestre tem a palavra final sobre o efeito.`,
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 3, description: `como o aprimoramento anterior, mas você pode escolher magias de 2º círculo. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `muda a execução para reação. Em vez do normal, você recebe +5 na Defesa e em testes de Reflexos contra um ataque ou efeito que esteja prestes a atingi-lo. Após a resolução do efeito, salta para um espaço adjacente (1,5m).` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para pessoal, o alvo para você, a duração para cena e a resistência para nenhuma. Em vez do normal, seus ataques corpo a corpo passam a acertar inimigos distantes. Seu alcance natural aumenta em 3muma criatura Média pode atacar adversários a até 4,5m, por exemplo.` },
      { mpCost: 2, description: `aumenta o dano em +1d6.` },
      { mpCost: 4, description: `aumenta o empurrão em +3m.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, uma vez por rodada você pode gastar uma ação padrão para fazer um raio cair sobre um alvo na área, causando 3d8 pontos de dano de eletricidade (Reflexos reduz à metade).` },
      { mpCost: 2, description: `aumenta o dano de raios (veja acima) em +1d8.` },
      { mpCost: 3, description: `se escolheu causar chuva, ela se torna mais grossa, revelando a silhueta de criaturas invisíveis na área. Criaturas Médias ou menores ficam lentas e criaturas voadoras precisam passar num teste de Atletismo por rodada ou caem ao solo (mas podem fazer testes de Acrobacia para reduzir o dano de queda, como o normal).` },
      { mpCost: 3, description: `se escolheu causar granizo, muda o dano para 2d6 por rodada.` },
      { mpCost: 3, description: `se escolheu causar neve, criaturas na área sofrem 2d6 pontos de dano de frio no início de seus turnos.` },
      { mpCost: 3, description: `muda a área para cilindro com 90m de raio e 90m de altura.` },
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda a resistências para nenhum como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia, e recupera pontos de vida iguais à metade do dano da magia.` },
      { mpCost: 2, description: `aumenta o dano em +2d6.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 0, description: `muda a duração para cena. A ação adicional que você pode fazer é apenas de movimento. Uma criatura só pode receber uma ação adicional por turno como efeito de Velocidade.` },
      { mpCost: 7, description: `muda o alvo para criaturas escolhidas no alcance. Requer 4º círculo.` },
      { mpCost: 7, description: `muda o alcance para pessoal e o alvo para você. Você acelera sua mente, além de seu corpo. A ação adicional pode ser usada para lançar magias e ativar engenhocas. Requer 4º círculo.` },
      { mpCost: 1, description: `também deixa o alvo veloz. @ (DB #219)` },
    ],
  },
  {
    id: 'vestimenta-da-fe',
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: '1 armadura, escudo ou vestuário',
    duration: '1 dia',
    resistance: '',
    ...
    enhancements: [
      { mpCost: 3, description: `o objeto oferece o mesmo bônus em testes de resistência. Requer 3º círculo.` },
      { mpCost: 4, description: `aumenta o bônus em +1.` },
      { mpCost: 7, description: `o objeto também oferece redução de dano 5. Requer 4º círculo.` },
    ],
  },
  {
    id: 'voz-divina',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alcance para médio, a área para esfera com 3m de raio e o alvo para criaturas escolhidas.` },
      ...
      { mpCost: 4, description: `como acima, mas em vez de um fio, cria uma corrente de energia, com 20 PV e redução de dano 40.` },
      { mpCost: 4, description: `muda o alvo para área de cubo de 9m, a duração para permanente e adiciona componente material (chave de esmeralda no valor de T$ 2.000). Em vez do normal, nenhum tipo de movimento planar pode ser feito para entrar ou sair da área.` },
      { mpCost: 9, description: `muda o alcance para médio, a área para esfera com 3m de raio e o alvo para criaturas escolhidas. Cria um fio de energia (veja acima) que prende todos os alvos ao centro da área.` },
    ],
  },
  {
    id: 'anular-a-luz',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      { mpCost: 4, description: `muda as magias dissipadas para até 4º círculo. Requer 4º círculo.` },
      { mpCost: 9, description: `muda as magias dissipadas para até 5º círculo. Requer 5º círculo.` },
    ],
  },
  {
    id: 'banimento',
...
Se você tiver um ou mais itens que se oponham ao alvo de alguma maneira, a CD do teste de resistência aumenta em +2 por item. Por exemplo, se lançar a contra demônios do frio (vulneráveis a água benta e que odeiam luz e calor) enquanto segura um frasco de água benta e uma tocha acesa, a CD aumenta em +4. O mestre decide se determinado item é forte o bastante contra a criatura para isso.`,
    enhancements: [
      { mpCost: 0, description: `muda a resistência para nenhum. Em vez do normal, devolve automaticamente uma criatura conjurada (como por uma magia de convocação) para seu plano de origem.` },
    ],
  },
  {
    id: 'coluna-de-chamas',
    ...
    enhancements: [
      ...
      { mpCost: 1, description: `aumenta o dano de luz em +1d6.` },
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 8, description: `Muda os dados de auxílio para d12. Sempre que rolar um resultado 12 num desses dados, a entidade “suga” 2 PM de você. Requer 4º círculo.` },
    ],
  },
  {
    id: 'controlar-agua',
    ...
    description: `Você controlar os movimentos e comportamentos da água. Ao lançar a magia, escolha um dos efeitos abaixo.
...
Partir: diminui o nível de toda água mundana na área em até 4,5m. Em um corpo d’água raso, isso abre um caminho seco, que pode ser atravessado a pé. Em um corpo d’água profundo, cria um redemoinho que pode prender barcos (um teste de Pilotagem com CD igual à da magia permite ao piloto livrar a embarcação). Elementais da água na área ficam lentos.`,
  ...
  },
  {
    ...
    castingTime: 'padrão',
    range: 'ilimitado',
    area: '1 objeto de até 2 espaços',
    duration: 'instantânea',
    resistance: '',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, até 1 hora após ter lançado a magia, você pode gastar uma ação de movimento para enviar o objeto de volta para o local em que ele estava antes.` },
      ...
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `muda o alvo para 1 objeto de até 10 espaços. Um objeto muito grande ou pesado para aparecer em suas mãos surge em um espaço adjacente a sua escolha.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 4, description: `muda a duração para permanente e adiciona penalidade de –3 PM.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 4, description: `muda o alcance para curto, a área para alvo 1 criatura e a duração para cena. O alvo fica imune a efeitos de trevas.` },
      { mpCost: 4, description: `muda o círculo máximo des dissipadas para 4º. Requer 4º círculo.` },
      { mpCost: 9, description: `muda o círculo máximo des dissipadas para 5º. Requer 5º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `aumenta o dano em +1d12.` },
      { mpCost: 2, description: `muda o dano para trevas.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +1d8.` },
...
Uma magia que dissipe outras magias só dissipa o globo se for usada diretamente sobre você, não o afetando se usada em área. Efeitos mágicos não são dissipados quando entram na esfera, apenas suprimidos (voltam a funcionar fora do globo, caso sua duração não tenha acabado). O globo é imóvel e não tem efeito sobre criaturas ou objetos. Após lançá-lo, você pode entrar ou sair livremente.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda o bônus para +6.` },
    ],
  },
  {
    id: 'ilusao-lacerante',
    ...
    enhancements: [
      { mpCost: 3, description: `aumenta o dano em +2d6.` },
      { mpCost: 4, description: `muda a área para um cubo de 90m. Requer 4º círculo.` },
    ],
  },
  {
    id: 'imobilizar',
  ...
  },
  {
    ...
    duration: 'sustentada',
    resistance: '',
    description: `Você descobre informações sobre uma criatura, objeto ou local que esteja tocando. O que exatamente você descobre depende do mestre: talvez você não descubra tudo que há para saber, mas ganhe pistas para continuar a investigação. A cada rodada que mantiver a, você descobre:
...
• Se o alvo está sob influência de alguma magia e todas as informações sobre as magias ativas, se houver alguma.`,
    enhancements: [
      { mpCost: 4, description: `muda a execução para um dia, o alcance para ilimitado e adiciona componente material (cuba de ouro cheia d’água e ingredientes mágicos, no valor de T$ 1.000). Você ainda precisa ter alguma informação sobre o alvo, como um nome, descrição ou localização.` },
    ],
  },
  {
    id: 'manto-de-sombras',
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 9, description: `muda a duração para permanente e adiciona componente material (pó de diamante no valor de T$ 1.000). Requer 4º círculo.` },
    ],
  },
  {
    id: 'missao-divina',
    ...
    enhancements: [
      ...
      { mpCost: 4, description: `muda a duração para 1 ano ou até ser descarregada.` },
    ],
  },
  {
...
Gelo. Evoca uma parede grossa de gelo denso com 15cm de espessura. Na forma de cúpula, pode prender uma ou mais criaturas, mas elas têm direito a um teste de Reflexos para escapar antes que a cúpula se forme. Cada trecho de 3m da muralha tem Defesa 8, 40 PV e RD 5. Um trecho da muralha que atinja 0 PV será rompido. Qualquer efeito de fogo causa dano dobrado à muralha. Uma criatura que atravesse um trecho rompido da muralha sofre 4d6 pontos de dano de frio.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o dano por atravessar a muralha em +2d6.` },
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 4, description: `muda a duração para um dia.` },
      { mpCost: 4, description: `sua pele ganha aspecto e dureza de aço. Você recebe redução de dano 10. Requer 4º círculo.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus de Força em +1.` },
      { mpCost: 5, description: `aumenta a RD em +5.` },
      { mpCost: 2, description: `muda o alcance para toque e o alvo para 1 criatura. A magia falha se você e o alvo não forem devotos da mesma divindade.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 4, description: `muda o alcance para curto e o alvo para criaturas escolhidas dentro do alcance. Requer 4º círculo.` },
    ],
  },
  {
    id: 'servo-divino',
    ...
    enhancements: [
      { mpCost: 4, description: `muda a duração para um dia ou até ser descarregada. O espírito realiza uma tarefa a sua escolha que exija até um dia. O custo do pagamento aumenta para T$ 500. O resto segue normal.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `muda o componente material para pó de ônix negro (T$ 500). Em vez de um zumbi ou esqueleto, cria um carniçal. Ele pode funcionar como um parceiro veterano, escolhido entre ajudante, atirador, combatente, fortão ou guardião. O resto segue normal.` },
      { mpCost: 3, description: `muda o componente material para pó de ônix negro (T$ 500). Em vez de um zumbi ou esqueleto, cria uma sombra. Ela pode funcionar como um parceiro veterano, escolhido entre assassino, combatente ou perseguidor. O restante da magia segue normal.` },
      { mpCost: 7, description: `muda o componente material para ferramentas de embalsamar (T$ 1.000). Em vez de um zumbi ou esqueleto, cria uma múmia. Ela pode funcionar como um parceiro mestre, escolhido entre ajudante, destruidor, guardião ou médico. O restante da magia segue normal. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta a cura em +1d8+2.` },
...
Criaturas Médias ou menores podem ser arremessadas, mas têm direito a um teste de Vontade para evitar o efeito (em si mesmas ou em objetos que estejam segurando). Uma criatura arremessada contra uma superfície sólida sofre 1d6 pontos de dano de impacto para cada 3m que “voou” no deslocamento (incluindo outras criaturas; nesse caso, ambas sofrem o dano). Duração: instantânea`,
    enhancements: [
      { mpCost: 3, description: `aumenta o tamanho máximo da criatura em uma categoria (para Grande, Enorme e Colossal) ou dobra a quantidade de espaços do objeto.` },
    ],
  },
  {
    id: 'teletransporte',
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 2, description: `adiciona componente material (barra de adamante no valor de T$ 100). Sua forma de combate ganha um aspecto metálico e sem expressões. Além do normal, você recebe redução de dano 10 e imunidade a atordoamento e efeitos de cansaço, encantamento, metabolismo, trevas e veneno, e não precisa respirar.` },
    ],
  },
  {
    id: 'viagem-arborea',
...
• Tem uma parte do corpo do alvo (unhas, cabelos...): –10.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para toque e o alvo para 1 criatura.` },
      { mpCost: 4, description: `muda a duração para um dia. Requer 4º círculo.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alcance para pessoal e o alvo para área cone de 4,5m.` },
...
Terra: combatente, guardião ou montaria. Dano de impacto.`,
    enhancements: [
      { mpCost: 5, description: `o elemental muda para Enorme e recebe dois tipos de parceiro indicados no seu elemento.` },
      { mpCost: 5, description: `você convoca um elemental de cada tipo. Quando lança a magia, você pode escolher se cada elemental vai auxiliar você ou um aliado no alcance. Requer 5º círculo.` },
    ],
  },
  {
...
Reduzir: criaturas ou objetos livres Médios ou menores flutuam para cima e para baixo conforme sua vontade, com deslocamento de voo 6m. Criaturas na área recebem +20 em testes de Atletismo para escalar e saltar. Uma criatura levitando fica instável, sofrendo –2 em testes de ataque.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `a cúpula impede criaturas de se aproximarem a menos de 4,5m de você (ou seja, deve haver dois quadrados entre você e as criaturas).` },
      { mpCost: 5, description: `além do normal, criaturas afetadas também precisam fazer o teste de resistência se fizerem um ataque ou efeito à distância você. Se falharem, o efeito é desviado pela cúpula. Requer 5º círculo.` },
    ],
  },
  {
    id: 'desintegrar',
  ...
  },
  {
    ...
    duration: 'instantânea',
    resistance: 'Fortitude parcial',
    description: `Esta magia cria uma forte explosão de luzes estroboscópicas e sons cacofônicos que desorientam as criaturas atingidas. O efeito que cada criatura sofre depende do nível ou ND dela. Nível ou ND 4 ou menor: se falhar no teste de resistência, fica inconsciente. Se passar, fica atordoada por 1d4 rodadas e enjoada pelo resto da cena. Nível ou ND entre 5 e 9: se falhar no teste de resistência, fica atordoada por 1d4 rodadas e enjoada pelo resto da cena. Se passar, fica atordoada por 1 rodada e enjoada por 1d4 rodadas. Nível ou ND 10 ou maior: se falhar no teste de resistência, fica atordoada por 1 rodada e enjoada por 1d4 rodadas. Se passar, fica desprevenida e enjoada por 1 rodada. Uma criatura só pode ser atordoada por esta magia uma vez por cena.`,
    enhancements: [
    ],
  },
  {
...
Uma vez por rodada, durante o seu turno, o elemental pode se movimentar (deslocamento de voo 18m) e gastar quantos pontos de luz quiser para curar dano ou condições de criaturas em alcance curto, à taxa de 1 PV por 1 ponto de luz ou uma condição por 3 pontos de luz (entre abalado, apavorado, alquebrado, atordoado, cego, confuso, debilitado, enjoado, esmorecido, exausto, fascinado, fatigado, fraco, frustrado, ofuscado, pasmo, sangrando, surdo ou vulnerável). A magia é encerrada quando o elemental fica sem pontos de luz.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 5, description: `a magia não termina se o alvo chegar a 0 PV (o que significa que dano causado por essa magia pode matá-lo).` },
    ],
  },
  {
    id: 'manto-do-cruzado',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +1d6+5.` },
      { mpCost: 5, description: `muda o bônus adicional em Misticismo para +20. Requer 5º círculo.` },
    ],
  },
  {
    id: 'marionete',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `aumenta o comprimento em +15m e a altura em +3m.` },
      { mpCost: 5, description: `o muro é feito de uma massa de esqueletos animados. Sempre que uma criatura iniciar seu turno adjacente ou escalando a muralha, deve fazer um teste de Reflexos. Se falhar fica agarrada, sofrendo os efeitos normais de estar agarrada pela magia.` },
    ],
  },
  {
    id: 'premonicao',
    ...
    enhancements: [
      ...
      { mpCost: 10, description: `muda a duração para um dia.` },
    ],
  },
  {
    id: 'raio-polar',
    ...
    enhancements: [
      ...
      { mpCost: 5, description: `muda o alvo para área de esfera com 6m de raio. Em vez de um raio, você dispara uma bola de gelo que explode, causando o efeito da magia em todas as criaturas na área.` },
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano das rajadas em +1d6 e o dano da rajada mista em +2d12.` },
      { mpCost: 1, description: `muda a resistência para Reflexos (eletricidade, fogo) ou Fortitude (frio) parcial. Se falha, a criatura sofre uma condição de acordo com o elemento da magia: arrefecido (frio), eletrificado (eletricidade) ou em chamas (fogo). (DB #219)` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d8.` },
      { mpCost: 2, description: `muda o alvo para você, a duração para sustentada e o efeito para uma vez por rodada, como uma ação de movimento, você pode disparar uma lâmina de ar contra um alvo em alcance médio, causando 6d8 pontos de dano de corte (Fortitude reduz à metade).` },
    ],
  },
  {
    id: 'terremoto',
...
Não se conhece o destino das coisas sugadas pelo buraco negro. Alguns estudiosos sugerem que são enviadas para outros mundos — provavelmente Sombria, reino da deusa Tenebra.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de meteoros que atingem a área, o que aumenta o dano em +2d6 de impacto e +2d6 de fogo.` },
    ],
  },
  {
...
• Qualquer outra coisa que o mestre autorize, conforme os desejos e objetivos da divindade do conjurador.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda a área para esfera com 6m de raio e o alvo para criaturas escolhidas.` },
  ...
  },
  {
    ...
    resistance: 'Vontade parcial',
    description: `Você pronuncia uma palavra do idioma primordial da Criação, que causa um dos efeitos abaixo, a sua escolha. Atordoar: a criatura fica atordoada por 1d4+1 rodadas (apenas uma vez por cena). Se passar no teste de resistência, ou se já foi atordoada por esta magia, fica desprevenida por 1d4 rodadas. Cegar: a criatura fica cega. Se passar no teste de resistência, fica ofuscada por 1d4 rodadas. Matar: a criatura morre. Além do teste de Vontade, a criatura tem direito a um teste de Fortitude se tiver mais da metade de seus PV. Se passar em qualquer um deles, em vez de morrer perde 10d8 pontos de vida e fica sangrando.`,
    enhancements: [
    ],
  },
  {
...
Você adquire uma forma fantasmagórica invisível, mas pode se mostrar usando uma ação de movimento. Pode se mover em qualquer direção com deslocamento de voo 18m e, por ser incorpóreo, é capaz de atravessar objetos sólidos, mas fica limitado a se mover dentro dos limites do local, ou dentro de alcance curto da criatura alvo. Você pode ver e ouvir como se estivesse presente no local e pode falar mentalmente com qualquer criatura que possa ver, contanto que tenham um idioma em comum.`,
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 5, description: `muda o alvo para uma criatura que tenha morrido há até uma rodada. Esta magia pode curá-la.` },
    ],
  },
  {
    id: 'semiplano',
    ...
    enhancements: [
      ...
      { mpCost: 5, description: `muda a duração para permanente e adiciona componente material (maquete do semiplano feita de materiais preciosos no valor de T$ 5.000). Você pode lançar a magia diversas vezes para aumentar as dimensões do semiplano em +30m de lado a cada vez.` },
    ],
  },
  {
    id: 'sombra-assassina',
