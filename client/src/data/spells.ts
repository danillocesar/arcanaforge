...
Truque: o alimento é purificado (não causa nenhum efeito nocivo se estava estragado ou envenenado), mas não oferece bônus ao ser consumido.`,
    enhancements: [
      ...
      { mpCost: 1, description: `muda a duração para permanente, o alvo para 1 frasco com água e adiciona componente material (pó de prata no valor de T$ 5). Em vez do normal, cria um frasco de água benta.` },
    ],
  },
  {
    name: 'Acalmar Animal',
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para médio.` },
      { mpCost: 1, description: `muda o alvo para 1 monstro ou espírito com Inteligência 1 ou 2.` },
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 5, description: `muda o alvo para 1 monstro ou espírito. Requer 3º círculo.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `você lança a magia sem gesticular ou pronunciar palavras (o que permite lançar esta magia de armadura) e a adaga se torna invisível. Se o alvo falhar no teste de resistência, não percebe que você lançou uma magia contra ele.` },
      { mpCost: 2, description: `muda a duração para um dia. Além do normal, você “finca” a adaga na mente do alvo. Enquanto a magia durar, você sabe a direção e localização do alvo, desde que ele esteja no mesmo mundo.` },
      { mpCost: 2, description: `aumenta o dano em +1d6.` },
    ],
  },
  {
    name: 'Alarme',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `alvos que falhem na resistência ficam apavorados por 1d4+1 rodadas, em vez de apenas 1.` },
      { mpCost: 2, description: `muda o alvo para 1 criatura.` },
      { mpCost: 5, description: `afeta todos os alvos válidos a sua escolha dentro do alcance.` },
    ],
  },
  {
...
Área Escorregadia pode tornar um item escorregadio. Uma criatura segurando um objeto afetado deve passar na resistência para não deixar o item cair cada vez que usá-lo.`,
    enhancements: [
      { mpCost: 1, description: `aumenta a área em +1 quadrado de 1,5m.` },
      { mpCost: 2, description: `muda a CD dos testes de Acrobacia para 15.` },
      { mpCost: 5, description: `muda a CD dos testes de Acrobacia para 20.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, a arma também protege você, oferecendo +1 na Defesa.` },
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      { mpCost: 2, description: `muda a duração para sustentada. Além do normal, uma vez por rodada, você pode gastar uma ação livre para fazer a arma acertar automaticamente um alvo em alcance curto. Se a arma atacar, não poderá contra-atacar até seu próximo turno. Requer 2º círculo.` },
      { mpCost: 2, description: `muda o tipo do dano para essência. Requer 2º círculo.` },
      { mpCost: 5, description: `invoca duas armas, permitindo que você contra-ataque (ou ataque, se usar o aprimoramento acima) duas vezes por rodada. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Arma Mágica',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus em +1 (bônus máximo limitado pelo círculo máximo de magia que você pode lançar).` },
      { mpCost: 2, description: `a arma causa +1d6 de dano de ácido, eletricidade, fogo ou frio, escolhido quando a magia é lançada. Este aprimoramento só pode ser usado uma vez.` },
      { mpCost: 3, description: `muda o bônus de dano do aprimoramento acima para +2d6.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a execução para reação. Em vez do normal, você cria um escudo mágico que fornece +5 na Defesa contra o próximo ataque que sofrer (cumulativo com o bônus fornecido pelo efeito básico desta magia e armaduras).` },
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      { mpCost: 2, description: `muda a duração para 1 dia.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `fornece +1 nos testes de ataque com a arma.` },
      { mpCost: 2, description: `muda a execução para ação de movimento.` },
      { mpCost: 3, description: `aumenta o bônus nos testes de ataque em +1.` },
      { mpCost: 5, description: `aumenta o dano da arma em mais um passo.` },
    ],
  },
  {
    name: 'Aviso',
...
Localização: o alvo sabe onde você está naquele momento. Se você mudar de posição, ele não saberá.`,
    enhancements: [
      { mpCost: 1, description: `aumenta o alcance em um fator de 10 (90m para 900m, 900m para 9km, e assim por diante).` },
      { mpCost: 1, description: `se escolher mensagem, o alvo pode enviar uma resposta de até 25 palavras para você até o fim de seu próximo turno.` },
      { mpCost: 2, description: `se escolher localização, muda a duração para cena. O alvo sabe onde você está mesmo que você mude de posição.` },
      { mpCost: 3, description: `aumenta o número de alvos em +1.` },
    ],
  },
  {
    name: 'Bênção',
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alvo para 1 cadáver e a duração para 1 semana. O cadáver não se decompõe nem pode ser transformado em morto-vivo pela duração da magia.` },
      { mpCost: 2, description: `aumenta os bônus em +1, limitado pelo círculo máximo de magia que você pode lançar.` },
    ],
  },
  {
...
Truque: muda o alcance para pessoal e o alvo para você. Em vez do normal, você sabe onde fica o norte, e recebe +5 em testes de Sobrevivência para orientar-se.`,
    enhancements: [
      { mpCost: 1, description: `além do normal, a CD para rastrear os alvos em terreno natural aumenta em +10.` },
      { mpCost: 2, description: `aumenta o bônus de deslocamento em +3m.` },
    ],
  },
  {
    name: 'Comando',
...
Venha: o alvo gasta seu turno se aproximando de você (usando todas as suas ações).`,
    enhancements: [
      { mpCost: 1, description: `muda o alvo para 1 criatura.` },
      { mpCost: 2, description: `aumenta a quantidade de alvos em +1.` },
    ],
  },
  {
    name: 'Compreensão',
...
Você também pode gastar uma ação de movimento para ouvir os pensamentos de uma criatura tocada (você “ouve” o que o alvo está pensando), mas um alvo involuntário tem direito a um teste de Vontade para proteger seus pensamentos e evitar este efeito.`,
    enhancements: [
      { mpCost: 1, description: `muda o alcance para curto.` },
      { mpCost: 2, description: `muda o alcance para curto e o alvo para criaturas escolhidas. Você pode entender todas as criaturas afetadas, mas só pode ouvir os pensamentos de uma por vez.` },
      { mpCost: 2, description: `muda o alvo para 1 criatura. Em vez do normal, pode vasculhar os pensamentos do alvo para extrair informações. O alvo tem direito a um teste de Vontade para anular este efeito. O mestre decide se a criatura sabe ou não a informação que você procura. Requer 2º círculo.` },
      { mpCost: 5, description: `muda o alcance para pessoal e o alvo para você. Em vez do normal, você pode falar, entender e escrever qualquer idioma. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda a execução para padrão e a duração para cena. Requer 2° círculo.` },
      { mpCost: 5, description: `além do normal, ao atacar você, um inimigo deve rolar dois dados e usar o pior resultado. Requer 3° círculo.` },
      { mpCost: 9, description: `muda a execução para padrão, o alcance para curto, o alvo para criaturas escolhidas e a duração para cena. Requer 4° círculo.` },
      { mpCost: 14, description: `muda a execução para padrão e a duração para 1 dia. Além do normal, você recebe um sexto sentido que o avisa de qualquer perigo ou ameaça. Você fica imune às condições surpreendido e desprevenido e recebe +10 em Defesa e Reflexos. Requer 5º círculo.` },
    ],
  },
  {
...
Para efeitos de jogo, o monstro conjurado tem For 14, Des 17 e todos os outros atributos nulos. Ele tem 20 pontos de vida, não tem um valor de Defesa (ataques feitos contra ele acertam automaticamente) e usa o seu bônus para teste de Reflexos. Ele é imune a efeitos que pedem um teste de Fortitude ou Vontade.`,
    enhancements: [
      { mpCost: 1, description: `o monstro ganha deslocamento de escalada ou natação igual ao seu deslocamento terrestre.` },
      { mpCost: 1, description: `aumenta o deslocamento do monstro em +3m.` },
      { mpCost: 1, description: `muda o tipo de dano do ataque do monstro para ácido, fogo, frio ou eletricidade.` },
      { mpCost: 2, description: `o monstro ganha percepção às cegas.` },
      { mpCost: 2, description: `aumenta os PV do monstro em +10 para cada categoria de tamanho a partir de Pequeno (+10 PV para Pequeno, +20 PV para Médio etc.).` },
      { mpCost: 2, description: `aumenta o tamanho do monstro para Médio. Ele tem For 18, Des 16, 45 PV, deslocamento 12m, e seu ataque causa 2d6+4 pontos de dano.` },
      { mpCost: 2, description: `o monstro ganha resistência 5 contra dois tipos de dano (por exemplo, corte e frio).` },
      { mpCost: 4, description: `o monstro ganha uma nova ordem: Arma de Sopro. O monstro causa o dobro de seu dano de ataque em um cone de 6m a partir de si (Reflexos reduz à metade).` },
      { mpCost: 5, description: `aumenta o tamanho do monstro para Grande. Ele tem For 24, Des 14, 75 PV, deslocamento 12m, e seu ataque causa 3d6+7 pontos de dano com 3m de alcance. Requer 2º círculo.` },
      { mpCost: 9, description: `o monstro ganha deslocamento de voo igual ao dobro do deslocamento.` },
      { mpCost: 9, description: `o monstro ganha imunidade contra dois tipos de dano.` },
      { mpCost: 9, description: `aumenta o tamanho do monstro para Enorme. Ele tem For 32, Des 12, 110 PV, deslocamento 15m, e seu ataque causa 4d6+11 pontos de dano com 4,5m de alcance. Requer 4º círculo.` },
      { mpCost: 14, description: `aumenta o tamanho do monstro para Colossal. Ele tem For 41, Des 10, 180 PV, deslocamento 15m, e seu ataque causa 6d6+15 de dano com 9m de alcance. Requer 5º círculo.` },
    ],
  },
  {
    name: 'Consagrar',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, mortos-vivos na área sofrem –2 em testes e Defesa.` },
      { mpCost: 2, description: `aumenta as penalidades para mortos-vivos em –1.` },
      { mpCost: 9, description: `muda a execução para 1 hora, a duração para permanente e adiciona componente material (incenso e óleos no valor de T$ 1.000). Requer 4º círculo.` },
    ],
  },
  {
...
Truque: muda a área para alvo de 1 planta e a resistência para nenhuma. Em vez do normal, você pode fazer a planta se mover como se fosse animada. Ela não pode causar dano ou atrapalhar a concentração de um conjurador.`,
    enhancements: [
      { mpCost: 1, description: `muda a duração para instantânea. Em vez do normal, as plantas na área diminuem, como se tivessem sido podadas. Terreno difícil muda para terreno normal e não oferece camuflagem. Esse efeito anula o uso normal de Controlar Plantas.` },
      { mpCost: 1, description: `além do normal, criaturas que falhem na resistência também ficam imóveis.` },
      { mpCost: 2, description: `muda o alcance para pessoal, a área para alvo (você) e a resistência para nenhuma. Em vez do normal, você consegue se comunicar com plantas, que começam com atitude prestativa em relação a você. Além disso, você pode fazer testes de Diplomacia com plantas. Em geral, plantas têm uma percepção limitada de seus arredores e normalmente fornecem respostas simplórias.` },
    ],
  },
  {
...
Terra: cria um cubo de tamanho Minúsculo feito de terra, argila ou pedra.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a duração para sustentada. A cada rodada você pode usar uma ação livre para mover a imagem ou alterar levemente o som, como aumentar o volume ou fazer com que pareça se afastar ou se aproximar, ainda dentro dos limites do efeito. Você pode, por exemplo, criar a ilusão de um fantasma que anda pela sala, controlando seus movimentos. Quando você para de sustentar a magia, a imagem ou som persistem por mais uma rodada antes de a magia se dissipar.` },
      { mpCost: 1, description: `aumenta o efeito da ilusão em +1 cubo de 1,5m.` },
      { mpCost: 1, description: `também pode criar ilusões de imagem e sons combinados.` },
      { mpCost: 1, description: `também pode criar sons complexos com volume máximo equivalente ao que cinco pessoas podem produzir para cada cubo de 1,5m no efeito. Com uma ação livre, você pode alterar o volume do som ou fazê-lo se aproximar ou se afastar dentro do alcance.` },
      { mpCost: 2, description: `muda o alcance para longo e o efeito para esfera de 30m de raio. Em vez do normal, você cria um som muito alto, equivalente a uma multidão. Criaturas na área lançam magias como se estivessem em uma condição ruim, e a CD de testes de Percepção para ouvir aumenta em +10.` },
      { mpCost: 2, description: `também pode criar odores e sensações térmicas, que são percebidos a uma distância igual ao dobro do tamanho máximo do efeito. Por exemplo, uma miragem de uma fogueira com 4 cubos de 1,5m poderia emanar calor e cheiro de queimado a até 12m.` },
      { mpCost: 2, description: `também pode criar sensações táteis, como texturas; objetos ainda atravessam a ilusão, mas criaturas não conseguem atravessá-la sem passar em um teste de Vontade. A ilusão continua sem causar ou sofrer dano. Requer 2º círculo.` },
      ...
      { mpCost: 5, description: `muda a duração para sustentada. Além do normal, você pode gastar uma ação livre para modificar livremente a ilusão (mas não pode acrescentar novos aprimoramentos após lançá-la). Requer 3º círculo.` },
    ],
  },
  {
...
Truque: muda o alvo para 1 morto-vivo. Em vez do normal, causa 1d8 pontos de dano de luz (Vontade reduz à metade).`,
    enhancements: [
      { mpCost: 1, description: `aumenta a cura em +1d8+1.` },
      { mpCost: 2, description: `também remove uma condição de fadiga do alvo.` },
      { mpCost: 2, description: `muda o alcance para curto.` },
      { mpCost: 5, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
    ],
  },
  {
    name: 'Despedaçar',
    ...
    castingTime: 'padrão',
    range: 'curto',
    area: '1 criatura ou objeto mundano Pequeno',
    duration: 'instantânea',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +1d8+2.` },
      { mpCost: 2, description: `muda o alvo para objeto mundano Médio. Requer 2º círculo.` },
      { mpCost: 5, description: `muda o alvo para objeto mundano Grande. Requer 3º círculo.` },
      { mpCost: 9, description: `muda o alvo para objeto mundano Enorme. Requer 4º círculo.` },
      { mpCost: 14, description: `muda o alvo para objeto mundano Colossal. Requer 5º círculo.` },
      { mpCost: 5, description: `muda o alcance para pessoal e a área para explosão de 6m de raio. Todas as criaturas e objetos na área são afetados.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `você descobre também a raça ou espécie e o poder da criatura detectada (determinado pela aura dela). Criaturas de 1º a 6º nível ou ND geram aura tênue, criaturas de 7º a 12º nível ou ND geram aura moderada e criaturas de 13º ao 20º nível ou ND geram aura poderosa. Criaturas acima do 20º nível ou ND geram aura avassaladora.` },
      { mpCost: 2, description: `além do normal, você não fica surpreso desprevenido contra perigos detectados com sucesso e recebe +5 em testes de resistência contra armadilhas. Requer 2º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +1d6.` },
...
Truque: muda o alcance para toque, o alvo para 1 criatura e a duração para 1 semana. Em vez do normal, você faz uma pequena alteração na aparência do alvo, como deixar o nariz vermelho ou fazer brotar um gerânio no alto da cabeça. A mudança é inofensiva, mas persistente — se a flor for arrancada, por exemplo, outra nascerá no local.`,
    enhancements: [
      { mpCost: 1, description: `muda o alcance para curto e o alvo para 1 criatura. Uma criatura involuntária pode anular o efeito com um teste de Vontade.` },
      { mpCost: 1, description: `muda o alcance para curto e o alvo para 1 objeto. Você pode, por exemplo, transformar pedaços de ferro em moedas de ouro. Você recebe +10 em testes de Enganação para falsificação.` },
      { mpCost: 2, description: `a ilusão também inclui odores e sensações. Isso muda o bônus em testes de Enganação para disfarce para +20.` },
      { mpCost: 3, description: `muda o alcance para curto e o alvo para criaturas escolhidas. Cada criatura pode ter uma aparência diferente. Criaturas involuntárias podem anular o efeito com um teste de Vontade. Requer 2º círculo.` },
    ],
  },
  {
    name: 'Disparo Gélido',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +1d8+1.` },
      { mpCost: 1, description: `muda a resistência para Fortitude parcial. Se passar, a criatura reduz o dano à metade; se falhar, fica lenta até o final da cena.` },
    ],
  },
  {
    name: 'Enfeitiçar',
    ...
    enhancements: [
      ...
      { mpCost: 5, description: `muda o alvo para 1 espírito ou monstro. Requer 3º círculo.` },
      { mpCost: 5, description: `afeta todos os alvos dentro do alcance.` },
    ],
  },
  {
    name: 'Escudo da Fé',
    ...
    enhancements: [
      { mpCost: 1, description: `muda a execução para ação padrão, o alcance para toque e a duração para cena.` },
      { mpCost: 1, description: `também fornece ao alvo camuflagem contra ataques à distância.` },
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      ...
      { mpCost: 3, description: `muda a duração para 1 dia. Requer 2º círculo.` },
    ],
  },
  {
    name: 'Escuridão',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta a área da escuridão em +1,5m de raio.` },
      { mpCost: 2, description: `muda o efeito para fornecer camuflagem total por escuridão.` },
      { mpCost: 2, description: `muda a duração para 1 dia.` },
      { mpCost: 2, description: `muda o alvo para 1 criatura e a resistência para Fortitude parcial. Você lança a magia nos olhos do alvo, que fica cego pela cena. Se passar na resistência, fica cego por uma rodada. Requer 2º círculo.` },
      { mpCost: 5, description: `muda o alcance para pessoal e o alvo para você. Em vez do normal, você é coberto por sombras, recebendo +10 em testes de Furtividade e camuflagem por escuridão. Requer 2º círculo.` },
    ],
  },
  {
...
Truque: muda o alcance para curto, a área para alvo de 1 objeto e a resistência para Reflexos anula. Você gera uma pequena explosão que não causa dano mas pode acender uma vela, tocha ou fogueira. Também pode fazer um objeto inflamável com RD 0 (como uma corda ou pergaminho) ficar em chamas. Uma criatura em posse de um objeto pode evitar esse efeito se passar no teste de resistência.`,
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +1d6.` },
      { mpCost: 2, description: `muda a resistência para Reflexos parcial. Se passar, a criatura reduz o dano à metade; se falhar, fica em chamas (veja Condições, na página Regras para Combate ).` },
    ],
  },
  {
    name: 'Gêiser Cáustico',
    school: 'Evocação',
    spellType: 'Arcana',
    spellLevel: 1,
    castingTime: 'padrão',
    range: 'Médio',
    area: 'Cilindro com 3m de diâmetro e altura',
    duration: 'instantânea',
    resistance: 'Reflexos reduz à metade',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +1d6.` },
      { mpCost: 2, description: `Além do normal, o solo continua borbulhando em ácido venenoso até o final da cena, tornando-se terreno difícil. Qualquer criatura que entre na área ou comece o turno dentro dela sofre 2d6 pontos de dano de ácido (sem direito a teste de resistência).` },
    ],
  },
  {
    name: 'Hipnotismo',
    ...
    castingTime: 'padrão',
    range: 'curto',
    area: 'criaturas escolhidas de ND 2 ou menor',
    duration: '1d4 rodadas',
    resistance: 'Vontade anula',
    description: `Suas palavras e movimentos ritmados deixam as criaturas fascinadas (veja Condições, na página Regras para Combate ). Esta magia só afeta criaturas que possam perceber você. Se usar esta magia em combate, os alvos recebem +5 em seus testes de resistência.
...
Truque: muda o alvo para 1 criatura e a duração para 1 rodada. Em vez de fascinado, o alvo fica pasmo. Uma criatura só pode ser afetada por este truque uma vez por cena.`,
    enhancements: [
      { mpCost: 1, description: `em vez do normal, se passarem na resistência os alvos não saberão que foram alvos de uma magia.` },
      { mpCost: 2, description: `muda a duração para cena.` },
      { mpCost: 2, description: `muda o alcance para médio.` },
      { mpCost: 2, description: `afeta alvos de ND 5 ou menor. Requer 2º círculo.` },
      { mpCost: 5, description: `afeta alvos de ND 10 ou menor. Requer 3º círculo.` },
      { mpCost: 9, description: `afeta alvos de ND 15 ou menor. Requer 4º círculo.` },
      { mpCost: 14, description: `afeta alvos de qualquer ND. Requer 5º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de cópias em +1 (e o bônus na Defesa em +2).` },
      { mpCost: 5, description: `além do normal, toda vez que uma cópia é destruída, emite um clarão de luz. A criatura que destruiu a cópia fica ofuscada por uma rodada. Requer 2º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e o efeito da magia.` },
      { mpCost: 2, description: `além do normal, se falhar na resistência, o alvo fica fraco pela cena.` },
      { mpCost: 2, description: `aumenta o dano em 1d8+1.` },
      { mpCost: 5, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta a duração do efeito em +1 rodada.` },
      { mpCost: 2, description: `afeta alvos de ND 5 ou menor. Requer 2º círculo.` },
      { mpCost: 5, description: `afeta alvos de ND 10 ou menor. Requer 3º círculo.` },
      { mpCost: 9, description: `afeta alvos de ND 15 ou menor. Requer 4º círculo.` },
      { mpCost: 14, description: `afeta alvos de qualquer ND. Requer 5º círculo.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta a área iluminada em +3m de raio.` },
      { mpCost: 2, description: `muda a duração para 1 dia.` },
      { mpCost: 2, description: `muda a duração para permanente e adiciona componente material (pó de rubi no valor de T$ 50). Requer 2º círculo.` },
      { mpCost: 0, description: `(Apenas Arcanos) muda o alvo para 1 criatura. Você lança a magia nos olhos do alvo, que fica ofuscado pela cena. Não afeta criaturas cegas.` },
      ...
      { mpCost: 5, description: `(Apenas Divinos) muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo é envolto por um halo de luz, recebendo +10 em testes de Diplomacia e resistência a trevas 10. Requer 2º círculo.` },
    ],
  },
  {
    name: 'Névoa',
    ...
    enhancements: [
      { mpCost: 1, description: `a magia também funciona sob a água, criando uma nuvem de tinta.` },
      { mpCost: 2, description: `você pode escolher criaturas no alcance ao lançar a magia; elas enxergam através do efeito. Requer 2º círculo.` },
      { mpCost: 2, description: `além do normal, a nuvem tem um cheiro horrível. No início de seus turnos, qualquer criatura dentro dela, ou qualquer criatura com faro em alcance curto da nuvem, deve fazer um teste de Fortitude. Se falhar, fica enjoada por uma rodada.` },
      { mpCost: 2, description: `além do normal, a nuvem tem um tom esverdeado e se torna cáustica. No início de seus turnos, criaturas dentro dela sofrem 2d4 pontos de dano de ácido.` },
      { mpCost: 3, description: `aumenta o dano de ácido em +2d4.` },
      { mpCost: 5, description: `além do normal, a nuvem fica espessa, quase sólida. Qualquer criatura dentro dela tem seu deslocamento reduzido para 3m (independentemente de seu deslocamento normal) e sofre –2 em testes de ataque e rolagens de dano.` },
    ],
  },
  {
    name: 'Orientação',
    ...
    enhancements: [
      { mpCost: 2, description: `muda a duração para cena. Em vez do normal, escolha um atributo. Sempre que o alvo fizer um teste de perícia baseado no atributo escolhido, pode rolar dois dados e ficar com o melhor resultado. Não se aplica a testes de ataque ou resistência. Requer 2º círculo.` },
      { mpCost: 5, description: `como acima, mas, em vez de um atributo, escolha entre atributos físicos (Força, Destreza e Constituição) ou mentais (Inteligência, Sabedoria e Carisma). Requer 3º círculo.` },
      { mpCost: 5, description: `muda o alvo para criaturas escolhidas. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Perdição',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta as penalidades em –1, limitado pelo círculo máximo de magia que você pode lançar` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, o alvo recebe um bônus adicional de +20 em testes de Atletismo para saltar (para um bônus total de +30).` },
      { mpCost: 1, description: `além do normal, o alvo pode escalar paredes e tetos sem precisar fazer testes de Atletismo. Para isso, precisa estar com as mãos livres, mas pode usar uma única mão se ficar parado no lugar. O alvo não fica desprevenido enquanto escala.` },
      ...
      { mpCost: 3, description: `além do normal, ao fazer testes de perícias baseadas em Força, Destreza ou Constituição, o alvo pode rolar dois dados e escolher o melhor. Não afeta testes de ataque ou resistência. Requer 2º círculo.` },
    ],
  },
  {
    name: 'Profanar',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, mortos-vivos na área recebem +2 na Defesa e +2 em todos os testes.` },
      { mpCost: 2, description: `aumenta os bônus para mortos-vivos em +1.` },
      { mpCost: 9, description: `muda a execução para 1 hora, a duração para permanente e adiciona componente material (incenso e óleos no valor de T$ 1.000). Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus concedido em +1.` },
      { mpCost: 2, description: `muda a execução para reação, o alcance para curto e a duração para 1 rodada.` },
      { mpCost: 2, description: `muda o alvo para área de círculo com 3m de raio. Todos os aliados dentro do círculo recebem o bônus da magia. Requer 2º círculo.` },
      { mpCost: 5, description: `também torna o alvo imune a efeitos de encantamento. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Queda Suave',
    ...
    castingTime: 'reação',
    range: 'curto',
    area: '1 criatura ou objeto com até 200kg',
...
Truque: muda o alvo para objeto com até 5kg. Em vez do normal, você pode gastar uma ação de movimento para levitar o alvo até 4,5m em qualquer direção.`,
    enhancements: [
      { mpCost: 2, description: `muda o alvo para até 10 criaturas ou objetos.` },
    ],
  },
  {
...
Truque: muda o alcance para toque e a resistência para Fortitude anula. Em vez do normal, ao tocar o alvo, sua mão emana um brilho púrpura. O alvo fica fatigado. Note que, como efeitos de magia não acumulam, lançar este truque duas vezes contra o mesmo alvo não irá deixá-lo exausto.`,
    enhancements: [
      { mpCost: 2, description: `em vez do normal, se falhar na resistência o alvo fica exausto. Se passar, fica fatigado. Requer 2º círculo.` },
      { mpCost: 5, description: `em vez do normal, se falhar na resistência o alvo fica inconsciente. Se passar, fica exausto. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta a resistência em +5.` },
      { mpCost: 2, description: `muda a duração para 1 dia. Requer 2º círculo.` },
      { mpCost: 5, description: `muda o alcance para curto e o alvo para criaturas escolhidas. Requer 3º círculo.` },
      { mpCost: 5, description: `muda o efeito para resistência a dano de todos os tipos de energia. Requer 3º círculo.` },
      { mpCost: 9, description: `muda o efeito para imunidade a um tipo de dano de energia. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Santuário',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, escolha um tipo de criatura entre animal, construto ou morto-vivo. Você não pode ser percebido por criaturas do tipo escolhido, não importando o sentido usado.` },
      { mpCost: 9, description: `também protege o alvo contra efeitos de área. Uma criatura que tente atacar uma área que inclua o alvo deve fazer o teste de Vontade; se falhar, não consegue e perde a ação. Ela só pode tentar novamente se o alvo sair da área.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda as setas para lanças de energia que surgem e caem do céu. Cada lança causa 1d8+1 pontos de dano de essência. Requer 2º círculo.` },
      { mpCost: 2, description: `muda o número de setas/lanças para três.` },
      { mpCost: 4, description: `muda o número de setas/lanças para cinco. Requer 2º círculo.` },
      { mpCost: 9, description: `muda o número de setas/lanças para dez. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Sono',
    ...
    castingTime: 'padrão',
    range: 'curto',
    area: '1 criatura de ND 2 ou menor',
    duration: 'cena',
    resistance: 'Vontade parcial',
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alvo para área de quadrado com 3m de lado. Todas as criaturas na área dentro do limite de ND são afetadas.` },
      { mpCost: 2, description: `afeta alvos de ND 5 ou menor. Requer 2º círculo.` },
      { mpCost: 5, description: `afeta alvos de ND 10 ou menor. Requer 3º círculo.` },
      { mpCost: 5, description: `muda o alvo para criaturas escolhidas. Todas as criaturas no alcance dentro do limite de ND são afetadas.` },
      { mpCost: 9, description: `afeta alvos de ND 15 ou menor. Requer 4º círculo.` },
      { mpCost: 14, description: `afeta alvos de qualquer ND. Requer 5º círculo.` },
    ],
  },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, criaturas que falhem na resistência também ficam imóveis.` },
      { mpCost: 2, description: `além do normal, no início de seus turnos a magia afeta novamente qualquer criatura na área, exigindo um novo teste de Reflexos. Requer 2º círculo.` },
      { mpCost: 2, description: `aumenta a área em +1 cubo de 1,5m.` },
    ],
  },
  {
    name: 'Toque Chocante',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em 1d8+1.` },
      { mpCost: 2, description: `como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia.` },
      { mpCost: 2, description: `muda o alcance para pessoal e o alvo para área de explosão com 6m de raio. Você dispara raios pelas pontas dos dedos que afetam todas as criaturas na área.` },
    ],
  },
  {
    name: 'Tranca Arcana',
...
Truque: muda o alcance para curto. Em vez do normal, pode abrir ou fechar um objeto de tamanho Médio ou menor, como uma porta ou baú. Não afeta objetos trancados.`,
    enhancements: [
      { mpCost: 1, description: `muda o alcance para curto e a duração para instantânea. Em vez do normal, a magia abre portas, baús e janelas trancadas, presas, barradas ou protegidas por outra Tranca Arcana (neste caso, o efeito é dissipado). Ela também afrouxa grilhões e solta correntes.` },
      { mpCost: 5, description: `aumenta a CD para abrir o alvo em +5.` },
      { mpCost: 5, description: `muda o alvo para 1 objeto de qualquer tamanho, podendo afetar até mesmo os portões de um castelo. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Tranquilidade',
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alvo para 1 criatura.` },
      { mpCost: 1, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `aumenta a penalidade em –1.` },
      { mpCost: 5, description: `muda o alcance para médio e o alvo para criaturas escolhidas. Requer 3º círculo.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: 'matéria-prima, como madeira, rochas, ossos',
    duration: 'cena',
    resistance: '',
...
Truque: muda o alvo para 1 objeto mundano e a duração para instantânea. Em vez do normal, você pode alterar as propriedades físicas do objeto, como colorir, limpar ou sujar itens pequenos (incluindo peças de roupa), aquecer, esfriar e/ou temperar (mas não produzir) até 0,5kg de material inanimado (incluindo comida), ou curar 1 PV do objeto, consertando pequenas falhas como colar um frasco de cerâmica quebrado, unir os elos de uma corrente ou costurar uma roupa rasgada. Um objeto só pode ser afetado por este truque uma vez por dia.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o limite de tamanho do objeto em uma categoria.` },
      { mpCost: 1, description: `aumenta o preço máximo do objeto criado em + T$ 25.` },
      { mpCost: 1, description: `muda o alcance para toque, o alvo para 1 construto e a duração para instantânea. Em vez do normal, cura 2d8 PV do alvo. Você pode gastar 2 PM adicionais para aumentar a cura em +1d8.` },
      ...
      { mpCost: 9, description: `como o aprimoramento anterior, mas passa a afetar itens mágicos` },
    ],
  },
  {
    name: 'Visão Mística',
    ...
    enhancements: [
      { mpCost: 1, description: `recebe visão no escuro.` },
      { mpCost: 2, description: `muda a duração para 1 dia.` },
      { mpCost: 2, description: `também pode enxergar objetos e criaturas invisíveis. Eles aparecem como formas translúcidas.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta os PV temporários recebidos em +1d8.` },
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 7, description: `muda o aliado para mestre. Requer 3º círculo.` },
      { mpCost: 12, description: `muda o alvo para 2 animais prestativos. Cada animal funciona como um aliado de um tipo diferente, e você pode receber a ajuda de ambos (mas ainda precisa seguir o limite de aliados de acordo com o seu nível de personagem). Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo e seu equipamento aumentam de tamanho em uma categoria. O alvo também recebe Força +4. Um alvo involuntário pode fazer um teste de Fortitude para negar o efeito.` },
      { mpCost: 3, description: `muda o alcance para toque e o alvo para 1 criatura. Em vez do normal, o alvo e seu equipamento diminuem de tamanho em uma categoria. O alvo também recebe Destreza +4. Um alvo involuntário pode fazer um teste de Fortitude para negar o efeito. Requer 3º círculo.` },
      { mpCost: 7, description: `muda o alcance para toque, o alvo para 1 criatura, a duração para permanente e a resistência para Fortitude anula. Em vez do normal, se falhar na resistência o alvo e seu equipamento têm seu tamanho mudado para Minúsculo. O alvo também tem seu valor de Força reduzido a 1 e suas formas de deslocamento reduzidas a 3m. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `aumenta o número de cordas em um alvo a sua escolha em +1.` },
      { mpCost: 3, description: `em vez do normal, cada laço é destruído automaticamente com um único ataque bem-sucedido; porém, cada laço destruído libera um choque de energia que causa 1d6+1 pontos de dano de essência na criatura amarrada. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para toque e o alvo para 1 humanoide.` },
    ],
  },
  {
    name: 'Augúrio',
...
Por exemplo, se o grupo está prestes a entrar em uma câmara, o augúrio dirá “felicidade” se a câmara contém um tesouro desprotegido, “miséria” se contém um monstro, “felicidade e miséria” se houver um tesouro e um monstro ou “nada” se a câmara estiver vazia.`,
    enhancements: [
      ...
      { mpCost: 7, description: `o mestre rola 1d12; a magia só falha em um resultado 1.` },
      { mpCost: 12, description: `o mestre rola 1d20; a magia só falha em um resultado 1.` },
    ],
  },
  {
    name: 'Bola de Fogo',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d6.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a execução para reação e a duração para instantânea. Em vez do normal, você recebe resistência 30 contra o próximo dano que sofrer até o fim do turno atual.` },
      { mpCost: 1, description: `aumenta os PV temporários em +5 ou a resistência a dano em +10.` },
      ...
      { mpCost: 9, description: `como o aprimoramento acima, mas também muda a duração para sustentada. Tudo dentro da esfera fica praticamente sem peso. Uma vez por rodada, você pode gastar uma ação livre para flutuar a esfera e seu conteúdo para qualquer local dentro de alcance longo. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `a imagem do alvo fica ainda mais distorcida, oferecendo camuflagem total.` },
      { mpCost: 7, description: `muda o alcance para curto e o alvo para criaturas escolhidas. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 3, description: `muda a penalidade nas perícias para –10 (se passar na resistência) e –20 (se falhar). Requer 4º círculo.` },
      { mpCost: 7, description: `muda a duração para permanente e adiciona componente material (balança de prata no valor de T$ 5.000).` },
    ],
  },
  {
    name: 'Condição',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o número de alvos em +1.` },
      { mpCost: 1, description: `aumenta a duração para 1 dia.` },
    ],
  },
  {
...
Sombra: como o esqueleto, mas tem a habilidade incorpóreo, Des 18, 30 PV e causa 1d10 pontos de dano de trevas mais 1d10 pontos de dano de frio. Além disso, criaturas vivas atingidas por uma sombra devem passar num teste de Fortitude (CD igual à da magia) ou perdem 1d4 PM. Sombras perdem a habilidade incorpóreo quando expostas à luz do sol.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o número de mortos-vivos conjurados em +1.` },
      { mpCost: 3, description: `em vez de esqueletos, conjura carniçais (veja abaixo). Requer 3º círculo.` },
      { mpCost: 7, description: `em vez de esqueletos, conjura sombras (veja abaixo). Requer 4º círculo.` },
    ],
  },
  {
    name: 'Controlar Fogo',
...
Modelar: o alvo é 1 chama de tamanho Grande ou menor. A cada rodada, você pode gastar uma ação livre para movimentá-la 9m em qualquer direção. Se atravessar o espaço ocupado por uma criatura, causa 2d6 pontos de dano de fogo. Uma criatura só pode receber dano dessa maneira uma vez por rodada.`,
    enhancements: [
      ...
      { mpCost: 2, description: `aumenta o dano em +1d6.` },
      { mpCost: 3, description: `muda o alvo para 1 criatura composta principalmente por fogo, lava ou magma (como um elemental do fogo) e a resistência para Fortitude parcial. Em vez do normal, se a criatura falhar no teste de resistência, é reduzida a 0 PV. Se passar, sofre 5d6 pontos de dano.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'médio',
    area: '1 objeto de madeira Grande ou menor',
    duration: 'cena',
    resistance: '',
...
Retorcer: torna o alvo imprestável. Uma porta retorcida emperra (exigindo um teste de Força contra CD 25 para ser aberta). Armas e itens retorcidos impõem uma penalidade de –5 em testes de perícia. Escudos retorcidos deixam de oferecer qualquer bônus (mas ainda impõem penalidades). Um barco retorcido começa a afundar e naufraga ao final da cena. Os efeitos de regras em outros objetos de madeira ficam a cargo do mestre.`,
    enhancements: [
      ...
      { mpCost: 3, description: `muda o alvo para área de quadrado com 9m de lado e a duração para cena. Em vez do normal, qualquer vegetação na área fica rígida e afiada. A área é considerada terreno difícil e criaturas que andem nela sofrem 1d6 pontos de dano de corte para cada 1,5m que avancem.` },
      { mpCost: 7, description: `muda o alvo para objeto de madeira Enorme ou menor. Requer 3º círculo.` },
      { mpCost: 12, description: `muda o alvo para objeto de madeira Colossal ou menor. Requer 4º círculo.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `em vez do normal, as condições adquiridas são debilitado e esmorecido.` },
      { mpCost: 3, description: `em vez do normal, afeta qualquer tipo de criatura.` },
      { mpCost: 3, description: `além do normal, criaturas que falhem na resistência ficam aos prantos (em termos de regras, adquirem a condição pasmo) por 1 rodada. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Dissipar Magia',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +1d12.` },
      { mpCost: 3, description: `muda a resistência para Reflexos reduz à metade e o enxame para criaturas maiores, como gatos, guaxinins, compsognatos ou kobolds. Ele causa 3d12 pontos de dano (a sua escolha entre corte, impacto ou perfuração). O resto da magia segue normal.` },
      { mpCost: 5, description: `aumenta o número de enxames em +1. Eles não podem ocupar o mesmo espaço. Requer 3º círculo.` },
      { mpCost: 7, description: `muda a resistência para Reflexos reduz à metade e o enxame para criaturas elementais. Ele causa 5d12 pontos do dano (a sua escolha entre ácido, eletricidade, fogo ou frio). O resto da magia segue normal. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Esculpir Sons',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1. Todas as criaturas e objetos devem ser afetados da mesma forma.` },
    ],
  },
  {
    name: 'Físico Divino',
    ...
    enhancements: [
      { mpCost: 3, description: `em vez do normal, o alvo recebe +4 nos três atributos físicos. Requer 3º círculo.` },
      { mpCost: 7, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
      { mpCost: 7, description: `aumenta o bônus em +2. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Flecha Ácida',
...
Objetos soltos pelo alvo voltam a ser visíveis e objetos apanhados por ele ficam invisíveis. Uma luz transportada pelo alvo nunca fica invisível (mesmo que sua fonte seja). Qualquer parte de um item carregado que se estenda além de seu alcance corpo a corpo natural se torna visível.`,
    enhancements: [
      { mpCost: 1, description: `muda a execução para ação padrão, o alcance para toque e o alvo para 1 criatura ou 1 objeto.` },
      { mpCost: 3, description: `muda a duração para cena. Requer 3º círculo.` },
      ...
      { mpCost: 7, description: `muda a execução para ação padrão, o alcance para toque e o alvo para 1 criatura. A magia não é dissipada caso o alvo faça um ataque ou use uma habilidade ofensiva. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 3, description: `muda o alvo para 1 criatura. Em vez do normal, você cria um elo mental que permite que você veja e ouça através dos sentidos da criatura, se gastar uma ação de movimento. Uma criatura involuntária pode fazer um teste de Vontade para suprimir a magia por uma hora. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Localização',
...
Truque: muda a área para alvo você. Em vez do normal, você sabe onde fica o norte e recebe +5 em testes de Sobrevivência para se orientar.`,
    enhancements: [
      { mpCost: 5, description: `aumenta a área em um fator de 10 (90m para 900m, 900m para 9km, e assim por diante).` },
    ],
  },
  {
    name: 'Mapear',
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: 'superfície ou objeto plano, como uma mesa ou pergaminho',
    duration: 'cena',
    resistance: '',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `muda a duração para 1 dia. Se não estiver em combate, a criatura só pode fazer o teste de Vontade a cada hora. Requer 3º círculo.` },
      { mpCost: 3, description: `sempre que o alvo fizer o teste de Vontade e falhar, a marca causa 3d6 pontos de dano mental. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Mente Divina',
    ...
    enhancements: [
      { mpCost: 3, description: `em vez do normal, o alvo recebe +4 nos três atributos mentais. Requer 3º círculo.` },
      { mpCost: 7, description: `muda o alcance para curto e o alvo para criaturas escolhidas.` },
      { mpCost: 7, description: `aumenta o bônus em +2. Requer 4º círculo.` },
    ],
  },
...
Se mudar para outras formas, você pode escolher uma Forma Selvagem do druida (veja a página Druida). Nesse caso você não pode atacar com suas armas, falar ou lançar magias até voltar ao normal, mas recebe uma ou mais armas naturais e os bônus da forma selvagem escolhida.`,
    enhancements: [
      { mpCost: 1, description: `a forma escolhida recebe uma habilidade de sentidos entre faro, visão na penumbra e visão no escuro.` },
      { mpCost: 3, description: `a forma escolhida recebe percepção às cegas. Requer 3º círculo.` },
      { mpCost: 3, description: `muda o alcance para toque, o alvo para 1 criatura e adiciona resistência (Vontade anula).` },
      ...
      { mpCost: 5, description: `se mudar para formas não humanoides, pode escolher uma Forma Selvagem Aprimorada. Requer 3º círculo.` },
      { mpCost: 9, description: `se mudar para formas não humanoides, pode escolher uma Forma Selvagem Superior. Requer 4º círculo.` },
      { mpCost: 12, description: `além do normal, no início de seus turnos o alvo pode mudar de forma novamente, como uma ação livre, fazendo novas escolhas. Requer 5º círculo.` },
    ],
  },
  {
...
Truque: muda o alcance para toque, a área para alvo (1 criatura com 0 PV ou menos), a duração para instantânea e a resistência para Fortitude anula. Em vez do normal, você canaliza o Miasma contra uma vítima. Se falhar na resistência, ela morre e você recebe +2 na CD de suas magias por 1 dia. Se passar, fica imune a este truque por um dia.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +1d6.` },
      { mpCost: 3, description: `muda o tipo do dano para trevas.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, criaturas do tipo animal em alcance curto da montaria devem fazer um teste de Vontade. Se passarem, ficam abaladas pela cena; se falharem, ficam apavoradas por 1d4 rodadas, depois abaladas pela cena.` },
      { mpCost: 3, description: `muda a duração para permanente e adiciona sacrifício de 1 PM.` },
      { mpCost: 3, description: `aumenta o tamanho da montaria em uma categoria. Isso também aumenta o número de criaturas que ela pode carregar — duas para uma criatura Enorme, seis para Colossal. Uma única criatura controla a montaria; as outras apenas são deslocadas.` },
      { mpCost: 3, description: `muda a criatura para um aliado montaria mestre. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Oração',
    ...
    castingTime: 'padrão',
    range: 'curto',
    area: 'todas as criaturas (veja texto)',
    duration: 'sustentada',
    resistance: '',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta os bônus em +1, limitado pelo círculo máximo de magia que você pode lançar.` },
      { mpCost: 2, description: `aumenta as penalidades em –1, limitado pelo círculo máximo de magia que você pode lançar.` },
      { mpCost: 7, description: `muda o alcance para médio. Requer 3º círculo.` },
      { mpCost: 12, description: `muda a duração para cena. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Purificação',
    ...
    enhancements: [
      { mpCost: 2, description: `também cura todo o dano causado por venenos.` },
      { mpCost: 2, description: `em vez de uma, remove todas as condições listadas.` },
      { mpCost: 3, description: `também permite que o alvo solte qualquer item amaldiçoado que esteja segurando (mas não remove a maldição do item em si).` },
      { mpCost: 7, description: `também dissipa magias e efeitos prejudiciais de encantamento, necromancia e transmutação afetando o alvo. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Raio Solar',
...
Truque: muda a duração para cena e a resistência para nenhuma. Em vez do normal, cria um facho de luz, que ilumina a área da magia. Uma vez por rodada, você pode mudar a direção do facho como uma ação livre.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o dano ou cura em +1d8 (ou +1d12 em mortos-vivos).` },
      { mpCost: 3, description: `em vez do normal, criaturas vivas a sua escolha na área curam 4d8 pontos de vida; o restante sofre o dano normalmente.` },
      { mpCost: 3, description: `criaturas que falhem na resistência ficam cegas por 1d4 rodadas.` },
    ],
  },
  {
    name: 'Refúgio',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d6.` },
      { mpCost: 3, description: `muda a área para alvo (criaturas escolhidas). Em vez do normal, você dispara vários relâmpagos, um para cada alvo escolhido, causando 6d6 pontos de dano de eletricidade. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Rogar Maldição',
...
Você também pode inventar sua própria maldição, usando esses exemplos como sugestões, mas o mestre tem a palavra final sobre o efeito.`,
    enhancements: [
      { mpCost: 3, description: `aumenta o número de efeitos que você pode escolher em +1. Requer 3º círculo.` },
      { mpCost: 7, description: `muda a duração para permanente e resistência para Fortitude parcial. Se passar, a criatura ainda sofre os efeitos da maldição, mas por 1 rodada. Requer 4º círculo.` },
    ],
  },
  {
    ...
    castingTime: 'completa',
    range: 'toque',
    area: '1 objeto ou passagem de até 6m de largura',
    duration: 'permanente até ser descarregada',
    resistance: 'nenhum ou Reflexos reduz à metade (veja o texto)',
...
Componente material: pó de diamante no valor de T$ 200, com o qual o conjurador desenha a runa, que brilha por alguns instantes e depois se torna praticamente invisível.`,
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em +2d6.` },
      { mpCost: 1, description: `muda o alvo para 1 objeto que possa ser lido, como um livro, pergaminho ou mapa. A runa explode quando o objeto é lido. O objeto também sofre o dano (possivelmente sendo destruído).` },
      { mpCost: 1, description: `este aprimoramento exige que você lance uma magia de até 2º círculo como parte da execução da Runa de Proteção. Quando a runa é ativada, em vez do efeito normal, lança essa magia sobre a criatura que o ativou (se for uma magia de área, a área é centrada na criatura).` },
      { mpCost: 3, description: `como o aprimoramento acima, mas além de lançar a magia, a runa também causa o dano do efeito normal. Você define a ordem que os efeitos acontecem.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para médio.` },
      { mpCost: 1, description: `muda o alvo para você e uma criatura voluntária. Você pode escolher este aprimoramento mais vezes para aumentar o número de alvos adicionais em +1, mas deve estar tocando todos os alvos.` },
      { mpCost: 2, description: `muda a execução para reação. Em vez do normal, você salta para um espaço adjacente (1,5m), recebendo +5 na Defesa e em testes de Reflexos contra um ataque ou efeito que esteja prestes a atingi-lo.` },
      { mpCost: 3, description: `muda o alcance para longo.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'longo',
    area: 'até 5 criaturas conjuradas',
    duration: '1 dia',
    resistance: '',
...
Eles também podem ajudá-lo em tarefas mais complexas, como fazer uma pesquisa ou preparar uma poção, mas isso consome sua energia mágica. Você pode “gastar” um servo para receber um bônus não cumulativo de +2 em um teste de perícia (exceto testes de ataque e resistência). Os servos não são criaturas reais; não podem lutar, nem resistir a qualquer dano ou efeito que exija um teste de resistência ou teste oposto — falharão automaticamente no teste e serão destruídos.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para pessoal, o alvo para você, a duração para cena e a resistência para nenhuma. Em vez do normal, seus ataques corpo a corpo passam a acertar inimigos distantes. Seu alcance natural aumenta em 3m; uma criatura Média pode atacar adversários a até 4,5m, por exemplo.` },
      { mpCost: 2, description: `aumenta o dano em +1d6.` },
      { mpCost: 4, description: `aumenta a distância do efeito de empurrar em +3m.` },
      { mpCost: 5, description: `muda o tipo do dano para essência.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano de frio em +2d6.` },
      { mpCost: 2, description: `além do normal, criaturas que falhem no teste de Fortitude ficam caídas.` },
      { mpCost: 3, description: `aumenta o tamanho máximo das criaturas afetadas em uma categoria. Requer 3º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 3, description: `muda o alvo para 1 criatura.` },
      { mpCost: 12, description: `muda o alvo para criaturas escolhidas. Requer 5º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda a duração para sustentada. Além do normal, uma vez por rodada, como uma ação padrão, você pode fazer um relâmpago cair sobre um alvo na área, causando 3d8 pontos de dano de eletricidade (Reflexos reduz à metade).` },
      { mpCost: 1, description: `se escolheu causar granizo, muda o dano para 1d6.` },
      { mpCost: 2, description: `aumenta o dano em +1 dado do mesmo tipo.` },
      { mpCost: 3, description: `se escolheu causar chuva, ela revela criaturas e objetos invisíveis na área.` },
      { mpCost: 7, description: `se escolheu causar neve, criaturas na área sofrem 2d6 pontos de dano de frio no início de seus turnos.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `como parte da execução da magia, você pode fazer um ataque corpo a corpo contra o alvo. Se acertar, causa o dano do ataque e da magia, e recupera pontos de vida iguais à metade do dano da magia.` },
      { mpCost: 2, description: `aumenta o dano em +2d6.` },
      { mpCost: 2, description: `muda o alcance para pessoal, o alvo para você e a duração para cena. Em vez do normal, a cada rodada você pode gastar uma ação padrão para tocar 1 criatura e causar 3d6 pontos de dano. Você recupera pontos de vida iguais à metade do dano causado. Requer 3º círculo.` },
    ],
  },
  {
    name: 'Velocidade',
    ...
    enhancements: [
      { mpCost: 7, description: `muda o alvo para criaturas no alcance. Requer 4º círculo.` },
      { mpCost: 7, description: `muda o alcance para pessoal e o alvo para você. Você acelera sua mente, além do seu corpo. A ação adicional pode ser usada para lançar magias e ativar engenhocas. Requer 4º círculo.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: '1 traje, armadura ou escudo',
    duration: '1 dia',
    resistance: '',
    ...
    enhancements: [
      { mpCost: 3, description: `o objeto também oferece o mesmo bônus em testes de resistência. Requer 3º círculo.` },
      { mpCost: 4, description: `aumenta o bônus em +1.` },
      { mpCost: 7, description: `o objeto também oferece resistência a dano 5. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Voz Divina',
    ...
    enhancements: [
      { mpCost: 1, description: `você concede um pouco de vida a um cadáver, suficiente para que ele responda a suas perguntas. O conhecimento do corpo é limitado ao que ele tinha enquanto vivo e suas respostas são curtas e enigmáticas. Um corpo só pode ser alvo desta magia uma vez. Ela também não funciona em um corpo cuja cabeça tenha sido destruída.` },
      { mpCost: 1, description: `você pode falar com plantas (normais ou monstruosas) e rochas. Plantas e rochas têm percepção limitada de seus arredores e normalmente fornecem respostas simplórias.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alcance para médio, a área para círculo de 3m de raio e o alvo para criaturas escolhidas.` },
      ...
      { mpCost: 4, description: `como acima, mas em vez de um fio, cria uma corrente de energia, com 20 PV e resistência a dano 40.` },
      { mpCost: 4, description: `muda o alvo para área de cubo de 9m, a duração para permanente e adiciona componente material (chave de esmeralda no valor de T$ 2.000). Em vez do normal, nenhum tipo de movimento planar pode entrar ou sair da área.` },
      { mpCost: 9, description: `muda o alcance para médio, a área para círculo de 3m de raio e o alvo para criaturas escolhidas. Cria um fio de energia (veja acima) que prende todos os alvos ao centro da área.` },
    ],
  },
  {
    name: 'Anular a Luz',
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus na Defesa em +1.` },
      { mpCost: 4, description: `muda o círculo máximo de magias dissipadas para 4º.` },
      { mpCost: 9, description: `muda o círculo máximo de magias dissipadas para 5º.` },
    ],
  },
  {
    name: 'Banimento',
...
Se você tiver um ou mais itens que se oponham ao alvo de alguma maneira, a CD do teste de resistência aumenta em +2 por item. Por exemplo, se lançar a magia contra demônios do frio (vulneráveis a água benta e que odeiam luz e calor) enquanto segura um frasco de água benta e uma tocha acesa, a CD do teste de resistência aumenta em +4. O mestre decide se determinado item é forte o bastante contra a criatura para isso.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano de fogo em +1d6.` },
      { mpCost: 1, description: `aumenta o dano de eletricidade em +1d6.` },
    ],
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 3, description: `aumenta o número de dados de auxílio em +2.` },
      { mpCost: 4, description: `muda o tipo dos dados de auxílio para d6.` },
      { mpCost: 8, description: `muda o tipo dos dados de auxílio para d8.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o número de dados de auxílio em +1.` },
      { mpCost: 8, description: `Muda os dados de auxílio para d12. Sempre que rolar um resultado 12 num desses d12, a entidade “suga” 2 PM de você. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Controlar Água',
...
Partir: diminui o nível de toda água mundana na área em até 4,5m. Em um corpo d’água raso, isso abre um caminho seco, que pode ser atravessado a pé. Em um corpo d’água profundo, cria um redemoinho que pode prender barcos (um teste de Pilotagem com CD igual à da magia permite ao piloto livrar a embarcação). Elementais da água na área ficam lentos.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d8.` },
    ],
  },
  {
...
Solidificar: transforma lama ou areia em terra ou pedra. Criaturas com os pés na superfície ficam agarradas. Elas podem se soltar com uma ação padrão e um teste de Acrobacia ou Atletismo.`,
    enhancements: [
      { mpCost: 1, description: `aumenta o número de cubos de 1,5m em +2.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, até 1 hora depois que lançou a magia, você pode gastar uma ação de movimento para enviar o objeto de volta para o local em que ele estava antes.` },
      ...
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 2, description: `aumenta o peso limite do alvo em um fator de 10, até 500 kg. Um objeto muito grande ou pesado para aparecer em suas mãos é teletransportado para um espaço adjacente a sua escolha.` },
    ],
  },
  {
...
Se não quiser ter o alvo como aliado, você pode pedir que ele proteja um local específico, atacando invasores (nesse caso, use as estatísticas apropriadas à criatura; plantas usam as estatísticas de entes).`,
    enhancements: [
      { mpCost: 4, description: `muda o alvo para 1 escultura mundana inanimada. Além do normal, o alvo tem as mesmas características de um construto.` },
      { mpCost: 4, description: `muda a duração para permanente e adiciona sacrifício de 1 PM.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 4, description: `muda o alvo para área de cubo de 9m. Qualquer criatura ou objeto na área recebe o efeito da magia enquanto estiver dentro dela.` },
      { mpCost: 4, description: `muda a duração para 1 semana.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus nas resistências em +1.` },
      { mpCost: 4, description: `muda o alcance para curto, a área para alvo 1 criatura e a duração para cena. O alvo fica imune a efeitos de necromancia e trevas.` },
      { mpCost: 4, description: `muda o círculo máximo de magias dissipadas para 4º. Requer 4º círculo.` },
      { mpCost: 9, description: `muda o círculo máximo de magias dissipadas para 5º. Requer 5º círculo.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'médio',
    area: '1 enxame Grade (quadrado de 3m)',
    duration: 'sustentada',
    resistance: 'Reflexos parcial',
    ...
    enhancements: [
      { mpCost: 1, description: `além do normal, uma criatura que falhe no teste de Reflexos fica agarrada (o enxame escala e cobre o corpo dela). A criatura pode gastar uma ação padrão e fazer um teste de Acrobacia ou Atletismo para escapar. Se você mover o enxame, a criatura fica livre.` },
      { mpCost: 2, description: `aumenta o dano em +1d12.` },
      { mpCost: 2, description: `muda o tipo de dano para trevas.` },
      { mpCost: 3, description: `o enxame vira Enorme (quadrado de 6m de lado).` },
      { mpCost: 3, description: `o enxame ganha deslocamento de voo 18m e passa a ocupar um cubo ao invés de um quadrado.` },
      { mpCost: 4, description: `o enxame inclui parasitas inchados que explodem e criam novos enxames. No início de cada um de seus turnos, role 1d6. Em um resultado 5 ou 6, um novo enxame surge adjacente a um já existente à sua escolha. Você pode mover todos os enxames com uma única ação de movimento, mas eles não podem ocupar o mesmo espaço. Requer 4º círculo.` },
    ],
  },
  {
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +1d6.` },
      { mpCost: 9, description: `muda alvo para criaturas escolhidas. Requer 5º círculo.` },
    ],
  },
  {
...
O globo é imóvel e não tem efeito sobre criaturas ou objetos. Após lançá-lo, você pode entrar ou sair livremente.`,
    enhancements: [
      { mpCost: 4, description: `muda o efeito para afetar magias de até 3º círculo. Requer 4º círculo.` },
      { mpCost: 9, description: `muda o efeito para afetar magias de até 4º círculo. Requer 5º círculo.` },
    ],
  },
  {
    name: 'Heroísmo',
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d6. O aumento pode ser de um novo tipo de dano, desde que explicado pela ilusão.` },
      { mpCost: 3, description: `aumenta o número de alvos em +1.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alvo para 1 espírito.` },
      { mpCost: 2, description: `aumenta o número de alvos em +1.` },
      { mpCost: 3, description: `muda o alvo para 1 criatura. Requer 4º círculo.` },
    ],
  },
  {
...
Respingos de rocha incandescente se espalham com a explosão, atingindo todas as criaturas adjacentes ao alvo, que devem fazer um teste de Reflexos. Se falharem, ficam em chamas, como descrito acima.`,
    enhancements: [
      { mpCost: 3, description: `aumenta o dano inicial em +2d6 e o dano do efeito em chamas em +1d6.` },
  ...
  },
  {
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: '1 criatura, objeto ou local',
    duration: 'sustentada',
    resistance: '',
...
- Se alvo está sob influência de alguma magia e todas as informações sobre as magias ativas, se houver alguma.`,
    enhancements: [
      { mpCost: 4, description: `muda a execução para 1 dia, o alcance para ilimitado e adiciona componente material (cuba de ouro cheia d’água e ingredientes mágicos, no valor de T$ 1.000). Você ainda precisa ter alguma informação sobre o alvo, como um nome, descrição ou localização.` },
    ],
  },
  {
...
Você pode gastar uma ação de movimento e 1 PM para “entrar” em uma sombra do seu tamanho ou maior e se teletransportar para outra sombra, também do seu tamanho ou maior, em alcance médio.`,
    enhancements: [
      { mpCost: 4, description: `muda o alcance para toque e o alvo para 1 criatura. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Miragem',
    ...
    enhancements: [
      { mpCost: 4, description: `além do normal, pode alterar a aparência de criaturas escolhidas na área, como se usando Disfarce Ilusório.` },
      { mpCost: 9, description: `muda a duração para permanente e adiciona componente material (pó de diamante no valor de T$ 1.000). Requer 5º círculo.` },
    ],
  },
  {
    name: 'Missão Divina',
...
A Missão Divina não pode forçar uma criatura a um ato suicida, nem designar uma missão impossível (como matar uma criatura que não existe).`,
    enhancements: [
      ...
      { mpCost: 4, description: `aumenta a duração para 1 ano ou até ser descarregada.` },
    ],
  },
  {
...
Gelo: Evoca uma parede grossa de gelo denso com 15cm de espessura. Na forma de cúpula, pode prender uma ou mais criaturas, mas elas têm direito a um teste de Reflexos para escapar antes que a cúpula se forme. Cada trecho de 3m da muralha tem Defesa 8, 40 PV e RD 5. Um trecho da muralha que atinja 0 PV será rompido. Qualquer efeito de fogo causa dano dobrado à muralha. Uma criatura que atravesse um trecho rompido da muralha sofre 4d6 pontos de dano de frio.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o comprimento em +15m e altura em +3m, até 60m de comprimento e 9m de altura.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para toque e o alvo para 1 criatura.` },
      { mpCost: 4, description: `muda a duração para 1 dia.` },
      { mpCost: 4, description: `sua pele ganha aspecto e dureza do aço. Você recebe resistência a dano 10. Requer 4º círculo.` },
      ...
      { mpCost: 9, description: `como acima, mas com duração permanente. Requer 5º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em 1d8+4.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o bônus de Força em +2.` },
      { mpCost: 2, description: `aumenta a resistência a dano em +2.` },
      { mpCost: 2, description: `muda o alcance para toque e o alvo para 1 criatura. A magia falha se o alvo não seguir a mesma divindade que você.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 4, description: `muda o bônus para +10. Requer 4º círculo.` },
      { mpCost: 4, description: `em vez do normal, o alvo fica imune a uma escola de magia a sua escolha. Requer 4º Círculo.` },
      { mpCost: 9, description: `em vez do normal, o alvo fica imune a duas escolas de magia a sua escolha. Requer 5º Círculo.` },
    ],
  },
  {
    name: 'Selo de Mana',
    ...
    enhancements: [
      { mpCost: 4, description: `muda o alcance para curto e o alvo para criaturas dentro do alcance. Requer 4º círculo.` },
    ],
  },
  {
    name: 'Servo Divino',
...
Componente material: um pagamento de T$ 100 ao espírito. A forma de pagamento varia — doações a um templo, um item mágico ou mesmo dinheiro.`,
    enhancements: [
      { mpCost: 4, description: `muda a duração para 1 dia ou até ser descarregada. O espírito realiza uma tarefa a sua escolha que exija até um dia, e aumenta o custo do pagamento para T$ 500. O resto segue normal.` },
      { mpCost: 9, description: `muda a duração para 1 semana ou até ser descarregada. O espírito realiza uma tarefa que exija até uma semana. O custo do pagamento aumenta para T$ 1.000. O resto segue normal.` },
    ],
  },
  {
...
Componente material: um ônix negro (T$ 100), inserido na boca ou olho do cadáver.`,
    enhancements: [
      { mpCost: 3, description: `muda o componente material para pó de ônix negro (T$ 500). Em vez de um zumbi ou esqueleto, cria um carniçal. Ele pode funcionar como um aliado veterano, escolhido entre ajudante, atirador, combatente, fortão ou guardião. O resto segue normal.` },
      { mpCost: 3, description: `muda o componente material para pó de ônix negro (T$ 500). Em vez de um zumbi ou esqueleto, cria uma sombra. Ela pode funcionar como um aliado veterano, escolhido entre assassino, combatente ou perseguidor. O restante da magia segue normal.` },
      { mpCost: 7, description: `muda o componente material para ferramentas de embalsamar (T$ 1.000). Em vez de um zumbi ou esqueleto, cria uma múmia. Ela pode funcionar como um aliado mestre, escolhido entre ajudante, destruidor, guardião ou médico. O restante da magia segue normal. Requer 4º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta a quantidade de cura em 1d8+2.` },
      { mpCost: 4, description: `além do normal, se um aliado estiver com PV negativos, seus PV são levados a 0 e então a cura é aplicada.` },
      { mpCost: 4, description: `remove todas as condições listadas, em vez de apenas uma.` },
    ],
  },
  {
    name: 'Telecinesia',
...
Criaturas dentro da capacidade de peso da magia podem ser arremessadas, mas têm direito a um teste de Vontade para evitar o efeito (em si mesmas ou em objetos que estejam segurando). Uma criatura arremessada contra uma superfície sólida sofre 1d6 pontos de dano de impacto para cada 3m que “voou” no deslocamento (incluindo outras criaturas; nesse caso, ambas sofrem o dano). Duração: instantânea.`,
    enhancements: [
      { mpCost: 3, description: `aumenta o limite de peso em 100kg.` },
    ],
  },
  {
    name: 'Teletransporte',
    ...
    castingTime: 'padrão',
    range: 'toque',
    area: 'até 5 criaturas voluntárias',
    duration: 'instantânea',
    resistance: '',
...
Se passar no teste, os alvos chegam ao lugar desejado. Se falhar, os alvos surgem 1d10 x 10km afastados em qualquer direção (se o destino é uma cidade costeira, você pode surgir em alto-mar). Se falhar por 5 ou mais, você chega em um lugar parecido, mas errado. E se você rolar 1 natural no teste a magia falha, mas você gasta PM normalmente e fica atordoado por 1d4 rodadas.`,
    enhancements: [
      { mpCost: 2, description: `aumenta o número de alvos em +5.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o raio da área em +3m.` },
      { mpCost: 2, description: `aumenta o dano dos tentáculos em +2d6.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta os bônus na Defesa, testes de ataque e rolagens de dano corpo a corpo em +1, e os PV temporários em +10.` },
      { mpCost: 2, description: `adiciona componente material (uma barra de adamante no valor de T$ 100). Sua forma de combate ganha um aspecto metálico e sem expressões. Você recebe resistência a dano 15/adamante e imunidade a atordoamento, dano não letal, doenças, encantamento, fadiga, paralisia, necromancia, sangramento, sono, veneno e não precisa respirar.` },
    ],
  },
  {
    name: 'Viagem Arbórea',
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alcance para toque, o alvo para até cinco criaturas e a duração para instantânea. Os alvos entram em uma planta (de tamanho Médio ou maior) e saem em outra planta do mesmo tamanho a até 100km de distância, especificada em direção e distância aproximadas (como “50km ao norte”).` },
    ],
  },
  {
    name: 'Vidência',
...
- Tem uma parte do corpo do alvo (unhas, cabelos...): –10.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para toque e o alvo para 1 criatura.` },
      { mpCost: 4, description: `muda a duração para 1 dia. Requer 4º círculo.` },
      { mpCost: 4, description: `muda o alcance para curto e o alvo para até 10 criaturas. Requer 4° círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alcance para cone de 4,5m e o alvo para criaturas na área.` },
      { mpCost: 5, description: `você pode alterar ou apagar as memórias das últimas 24 horas.` },
    ],
  },
  {
    name: 'Animar Objetos',
    ...
    castingTime: 'padrão',
    range: 'médio',
    area: 'até 8 objetos Minúsculos ou Pequenos, 4 objetos Médios, 2 objetos Grandes ou 1 objeto Enorme',
    duration: 'cena',
    resistance: '',
...
Enorme: For 18, Des 6, 60 PV; Fortão, Guardião ou Montaria Mestre.`,
    enhancements: [
      { mpCost: 5, description: `muda a duração para permanente e adiciona componente material (prataria no valor de T$ 1.000). Você pode ter um máximo de objetos animados igual à metade do seu nível.` },
    ],
  },
  {
...
Dissipar Magia não dissipa um Campo Antimagia, e dois Campos na mesma área não se neutralizam. Artefatos e deuses maiores não são afetados por um Campo Antimagia.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta a regeneração de PV em 1d8+1.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d6 (+2d8 contra mortos-vivos).` },
      { mpCost: 2, description: `aumenta a área em +6m de raio.` },
      { mpCost: 5, description: `a luz purificadora do Deus-Sol dissipa todas as magias de necromancia ativas na área. Requer 5º círculo.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 4, description: `muda o círculo da magia concedida para 3º e a penalidade de PM para –6.` },
    ],
  },
  {
...
Terra: combatente, guardião ou montaria. Dano de impacto.`,
    enhancements: [
      { mpCost: 5, description: `o elemental muda para Enorme e recebe dois tipos de aliado indicados no seu elemento.` },
      { mpCost: 5, description: `você convoca um elemental de cada tipo. Você pode ordenar que cada elemental auxilie você ou seus aliados. Requer 5º círculo.` },
    ],
  },
  {
...
Reduzir: a gravidade fica mais leve. Criaturas ou objetos livres com até 100kg flutuam para cima e para baixo conforme sua vontade, com deslocamento de voo 6m. Criaturas na área recebem +20 de bônus em testes de Atletismo para escalar e saltar. Uma criatura levitando fica instável, sofrendo –2 de penalidade em testes de ataque.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `(Apenas Druidas): muda o raio da área para 3km e duração para 1d4 dias.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `você pode se aproximar sem romper a cúpula.` },
      { mpCost: 4, description: `como normal, mas você pode escolher um tipo de criaturas sem limitação (todos os animais, todos os monstros etc.).` },
      { mpCost: 8, description: `muda a duração para sustentada. Além do normal, qualquer ataque, magia ou habilidade de uma criatura afetada é desviado pelo efeito e não o atinge. Requer 5º círculo.` },
    ],
  },
  {
    name: 'Desintegrar',
    ...
    enhancements: [
      { mpCost: 4, description: `aumenta o dano total em +2d12 e o dano mínimo em +1d12.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 3, description: `cria uma cópia adicional.` },
    ],
  },
  {
...
ND 10 ou maior: se falhar no teste de resistência, fica atordoada por 1 rodada e enjoada por 1d4 rodadas. Se passar, fica desprevenida e enjoada por 1 rodada.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 5, description: `muda o alcance para toque e o alvo para até 5 criaturas voluntárias que estejam de mãos dadas. Depois que a magia é lançada, as criaturas podem soltar as mãos. Requer 5º círculo.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'curto',
    area: 'elemental de luz invocado',
...
Uma vez por rodada, durante o seu turno, o elemental pode se movimentar (deslocamento de voo 18m) e gastar quantos pontos de luz quiser para curar dano ou condições de criaturas em alcance curto, à taxa de 1 PV por 1 ponto de luz ou uma condição por 3 pontos de luz (entre abalado, apavorado, alquebrado, atordoado, cego, confuso, debilitado, enjoado, esmorecido, exausto, fascinado, fatigado, fraco, frustrado, ofuscado, pasmo, sangrando, surdo ou vulnerável). A magia é encerrada quando o elemental fica sem pontos de luz.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `além do normal, o alvo pode caminhar sobre a água ou outros líquidos com seu deslocamento normal. Entretanto, isso não protege contra qualquer efeito que o líquido possa causar (o alvo pode andar sobre lava, mas ainda vai sofrer dano).` },
      { mpCost: 2, description: `além do normal, o alvo pode escolher 20 em todos os testes de Atletismo.` },
      { mpCost: 2, description: `além do normal, o alvo pode escolher 20 em todos os testes de Acrobacia e pode fazer todas as manobras desta perícia mesmo sem treinamento.` },
      { mpCost: 5, description: `muda o alcance para curto e o alvo para até 5 criaturas.` },
      { mpCost: 5, description: `pode dissipar Aprisionamento.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 5, description: `além do normal, o alvo também pode morrer por perda de PV ou se você morrer (um teste de Fortitude anula a morte).` },
    ],
  },
  {
...
Empurrar: a mão afasta o oponente, usando uma manobra empurrar com bônus de +20. A mão sempre acompanha o oponente para empurrá-lo até a distância máxima que conseguir, dentro do alcance da magia.`,
    enhancements: [
      { mpCost: 3, description: `aumenta o bônus dos testes em +5, e o dano de impacto em +1d6+6.` },
    ],
  },
  {
    name: 'Marionete',
...
É possível escalar a parede. Isso exige um teste de Atletismo e causa 4d8 pontos de dano de corte. Também é possível destruir o muro para atravessá-lo ou libertar uma criatura agarrada. Cada trecho de 3m do muro tem Defesa 8, 40 PV e resistência a corte, frio e perfuração 5.`,
  ...
  },
  {
    ...
    enhancements: [
      ...
      { mpCost: 5, description: `muda a duração para 1 dia.` },
    ],
  },
  {
    name: 'Raio Polar',
    ...
    enhancements: [
      { mpCost: 3, description: `aumenta o dano em +2d8.` },
      { mpCost: 5, description: `muda o alvo para área de explosão de 6m de raio. Em vez de um raio, você dispara uma esfera de gelo que explode, causando o efeito da magia em todas as criaturas na área.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 4, description: `aumenta o dano das rajadas em +1d6 e o dano da rajada mista em +2d12.` },
    ],
  },
  {
    name: 'Sonho',
    ...
    enhancements: [
      ...
      { mpCost: 1, description: `aumenta o número de alvos em +1. Todos os alvos compartilham um mesmo sonho (ou pesadelo) entre si e com você.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta o dano em +2d8.` },
      { mpCost: 2, description: `muda o alvo para você e a duração para sustentada. Uma vez por rodada, como uma ação padrão, você pode disparar uma lâmina de ar contra um alvo em alcance médio, causando 6d8 pontos de dano de corte (Fortitude reduz à metade).` },
    ],
  },
  {
    name: 'Terremoto',
...
Componente material: um bastão de metal precioso em forma de forquilha (no valor de T$ 1.000). O tipo de metal determina para qual plano de existência você será enviado. Os metais que levam a dimensões específicas podem ser difíceis de encontrar, de acordo com o mestre.`,
    enhancements: [
      { mpCost: 2, description: `muda o alvo para até cinco criaturas voluntárias que você esteja tocando.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `muda o alcance para toque e o alvo para 1 criatura.` },
      { mpCost: 1, description: `além do normal, o alvo fica com sentidos apurados; ele recebe +10 em todos os testes de Percepção.` },
      { mpCost: 2, description: `além do normal, o alvo escuta falsidades; ele recebe +10 em todos os testes de Intuição.` },
      { mpCost: 4, description: `além do normal, o alvo enxerga através de paredes e barreiras com 30cm de espessura ou menos (as paredes e barreiras parecem translúcidas).` },
    ],
  },
  {
...
Dissipar Magia pode dissipar o efeito, mas deve ser conjurada com o aprimoramento de 5º círculo e alvo na prisão.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `aumenta os bônus na Defesa e em testes de resistência em +1.` },
    ],
  },
  {
...
Esfera de frio: lento até o fim da cena`,
    enhancements: [
      { mpCost: 5, description: `aumenta o dano de cada esfera em +2d6.` },
      { mpCost: 5, description: `muda o tipo de dano de todas as esferas para essência (mas elas ainda causam os outros efeitos como se seu tipo de dano não mudasse).` },
    ],
  },
  {
    name: 'Buraco Negro',
...
Não se conhece o destino das coisas sugadas pelo buraco negro, uma vez que jamais retornam. Alguns estudiosos sugerem que podem ser enviadas para outros mundos. Muitos clérigos da Deusa da Noite acreditam que esta magia abre um portal para Sombria, o lar de sua deusa, e sonham um dia poder realizar essa jornada.`,
    enhancements: [
      { mpCost: 5, description: `muda o efeito para que você não seja afetado.` },
      { mpCost: 10, description: `muda o efeito para que criaturas escolhidas dentro do alcance não sejam afetadas.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `criaturas que falhem no teste de resistência ficam caídas e presas sob os escombros (agarradas). Uma criatura agarrada pode escapar gastando uma ação padrão e passando em um teste de Atletismo. Toda a área afetada fica coberta de escombros, sendo considerada terreno difícil.` },
      { mpCost: 10, description: `aumenta o número de meteoros em +1. Os meteoros podem cair na mesma área, para acumular o dano (uma criatura atingida por dois meteoros, por exemplo, sofre 40d6 pontos de dano) ou em uma área diferente (mas ainda dentro do alcance) para afetar mais alvos.` },
    ],
  },
  {
...
Voltar no tempo: você revive os últimos segundos. Todas as ações da rodada anterior são desfeitas (incluindo perda de PV e PM). Tudo retorna à posição em que estava no início do seu turno na última rodada e você é o único que sabe o que acontecerá. Todos os outros personagens envolvidos na cena devem repetir as mesmas ações — exceto se você fizer algo a respeito (como avisar seus aliados sobre o que vai acontecer).`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em 10.` },
      { mpCost: 5, description: `afeta apenas criaturas a sua escolha.` },
    ],
  },
  {
    name: 'Desejo',
...
Desejo pode gerar efeitos ainda mais poderosos, mas tenha cuidado! Desejar a fortuna de um rei pode transportá-lo para a sala de tesouro real, onde você será preso ou morto; desejar ser imortal pode transformá-lo em morto-vivo, e assim por diante. Qualquer efeito que não encaixe na lista acima deve ser decidido pelo mestre.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `em vez de flutuar no ponto em que foi conjurado, o disco flutua atrás de você, mantendo-se sempre adjacente.` },
      { mpCost: 4, description: `muda a duração para 1 dia.` },
    ],
  },
  {
    ...
    castingTime: 'completa',
    range: 'longo',
    area: 'nuvem de tempestade com 90m de lado',
    duration: 'sustentada',
    resistance: '',
...
Proteção física: você fica imune às condições atordoado, cego, debilitado, enjoado, envenenado, exausto, fatigado, fraco, lento, ofuscado e paralisado, além de acertos críticos, ataques furtivos e doenças.`,
    enhancements: [
      { mpCost: 5, description: `muda o alcance para curto e o alvo para 1 criatura.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 2, description: `muda a área para círculo de 6m de raio e o alvo para criaturas escolhidas.` },
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta o dano em 1d12.` },
    ],
  },
  {
    ...
    castingTime: 'padrão',
    range: 'curto',
    area: '1 criatura com menos níveis que você',
    duration: 'instantânea',
    resistance: 'Vontade parcial',
...
Matar: a criatura morre. Além do teste de Vontade, a criatura tem direito a um teste de Fortitude. Se passar em qualquer um deles, sofre 10d8 pontos de dano e fica sangrando.`,
  ...
  },
  {
    ...
    enhancements: [
      { mpCost: 5, description: `você ganha acesso às habilidades de raça e classe da criatura.` },
      { mpCost: 5, description: `enquanto a magia durar e você estiver dentro do alcance do seu corpo original, pode “saltar” de uma criatura possuída para outra. O novo alvo tem direito a um teste de Vontade. Se falhar, você assume o controle do corpo dele e o alvo anterior recobra a consciência.` },
  ...
  },
  {
    ...
    area: 'local ou criatura conhecidos',
    duration: 'sustentada',
    resistance: '',
...
Custo adicional: sacrifício de 1 PM.`,
    enhancements: [
      { mpCost: 5, description: `o objeto que abriga a alma detém os mesmos PM totais que o alvo. Se estiver empunhando o objeto, você pode usar esses PM para lançar magias no lugar dos seus. O objeto recupera PM por dia como se o personagem estivesse em descanso normal.` },
      { mpCost: 10, description: `como uma reação ao lançar esta magia, você possui o corpo sem alma do alvo, como na magia Possessão (mesmo que não conheça a magia).` },
    ],
  },
  {
    name: 'Segunda Chance',
    ...
    enhancements: [
      { mpCost: 1, description: `aumenta a cura em +20 PV.` },
      { mpCost: 2, description: `muda o alcance para curto e o alvo para até 5 criaturas.` },
      { mpCost: 5, description: `muda o alvo para uma criatura que tenha morrido a até uma rodada. Esta magia pode curá-la.` },
    ],
  },
  {
    name: 'Semiplano',
...
Você escolhe a forma e a aparência do semiplano — uma caverna, um asteroide que singra o éter, um palacete de cristal etc. Ele contém ar, luz e calor, mas além disso é vazio. Entretanto, você pode levar itens (mobília, ferramentas etc.) a cada viagem.`,
    enhancements: [
      ...
      { mpCost: 5, description: `muda a duração para permanente e adiciona componente material (diorama do semiplano feito de materiais preciosos no valor de T$ 5.000). Você pode lançar a magia diversas vezes para aumentar as dimensões do semiplano em +30m de lado a cada vez.` },
    ],
  },
  {
    ...
    enhancements: [
      { mpCost: 10, description: `muda o alvo para criaturas escolhidas na área.` },
    ],
  },
  {
    name: 'Toque da Morte',
    ...
    enhancements: [
      { mpCost: 2, description: `muda o alcance para curto. Em vez de tocar no alvo, você dispara um raio púrpura da ponta de seu dedo indicador.` },
      { mpCost: 10, description: `muda o alcance para curto e o alvo para inimigos no alcance. Em vez de tocar no alvo, você dispara raios púrpuras da ponta de seus dedos.` },
    ],
  },
];
